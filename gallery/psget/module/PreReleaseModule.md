...
* Förhandsversionen sträng har angetts i modulmanifestet i avsnittet PSData i PrivateData. Detaljerade krav på förhandsversionen strängen är lägre än. 
...
Om förhandsversionen objekt med PowerShellGet Sök-modulen, installera modulen Update-modulen och spara modulen kommandon kräver att lägga till flaggan - AllowPrerelease. Om - AllowPrerelease anges inkluderas förhandsversionen objekt om de finns.
...
Avinstallera modulen tar bort den senaste versionen av en modul när - RequiredVersion inte har angetts. Om - RequiredVersion anges, och är en förhandsversion, måste - AllowPrerelease läggas till kommandot. 
...
### <a name="uninstall-modulepsgetuninstall-modulemd"></a>[Avinstallera modul](./psget_uninstall-module.md)
