...
---
# <a name="update-scriptfileinfo"></a>Uppdatera ScriptFileInfo

Uppdatera ScriptFileInfo cmdlet kan du uppdatera befintliga skript filens metadata.

## <a name="description"></a>Beskrivning

Cmdlet Update ScriptFileInfo uppdateras informationen för ett skript.
- Uppdatera ScriptFileInfo cmdlet uppdaterar metadata i en skriptfil endast om den har skapats med New-ScriptFileInfo cmdlet eller med giltig PSScriptInfo kommentar.
- Också kan du lägga till filen skriptinformation till de befintliga filer som inte har skapats med New-ScriptFileInfo cmdlet.
- Om – Force anges försök lägga till metadata till befintlig skriptfil som inte har skapats med New-ScriptFileInfo cmdlet.
- Om testet ScriptFileInfo misslyckas med tolkningsfel, efter prepending skriptmetadata i den befintliga filen ett fel genereras om något som liknar ”det gick inte att lägga till metadata i den befintliga filen, du kan använda cmdleten nya scriptfileinfo att lägga till den metadata för befintliga skriptfilen som inte skapades med cmdlet New-ScriptFileInfo ”.
...
[Skript för uppdatering](http://go.microsoft.com/fwlink/?LinkId=619793)
...
### <a name="adding-the-script-metadata-to-the-existing-script-file"></a>Lägga till skriptmetadata i den befintliga skriptfilen
