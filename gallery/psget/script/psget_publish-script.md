...
---
# <a name="publish-script"></a>Publicera skript

Cmdlet Publish-skriptet publicerar det angivna skriptet till online-galleriet.

## <a name="description"></a>Beskrivning

Publicera skript-cmdleten låter dig om du vill publicera skriptfilen med giltiga metadata som Version, Guid, författare och beskrivning, osv. Tvingad switchparametern på Publicera skript cmdlet startar NuGet.exe utan att fråga.
...
[Publicera skript](http://go.microsoft.com/fwlink/?LinkId=619788)
