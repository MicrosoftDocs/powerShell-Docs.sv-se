...
---
# <a name="new-scriptfileinfo"></a>Ny ScriptFileInfo

Skapar en skriptfil med metadata.

## <a name="description"></a>Beskrivning

Cmdlet New-ScriptFileInfo skapar en PowerShell-skriptfil, inklusive metadata om skriptet.
...
[Ny ScriptFileInfo](http://go.microsoft.com/fwlink/?LinkId=619792)

## <a name="example-commands"></a>Exempel på kommandon

### <a name="passthru-parameter"></a>PassThru-parametern

```powershell
New-ScriptFileInfo -Description "Script file description." -PassThru
```

### <a name="new-scriptfileinfo-cmdlet"></a>Nya ScriptFileInfo cmdlet
Nya ScriptFileInfo cmdleten låter dig för att skapa en ny skriptfil med metadata som Version, Guid, författare och beskrivning, osv. 
