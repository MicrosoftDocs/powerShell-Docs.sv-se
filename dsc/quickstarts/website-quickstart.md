...
Exemplet använder vi ser till att en server har den `Web-Server` (IIS)-funktionen aktiverad och som innehållet för en enkel ”Hello World”-webbplats finns i den `intepub\wwwroot` katalogen i den här servern.
