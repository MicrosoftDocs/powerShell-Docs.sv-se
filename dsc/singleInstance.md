...
Att kontrollera att en konfiguration kan tidszonen för en målnod bara en gång, resursen har uppdaterats för att lägga till en andra egenskap **IsSingleInstance**, som blev nyckelegenskapen.
Den **IsSingleInstance** har begränsad till ett enda värde ”Ja” med hjälp av en **ValueMap**. Det gamla MOF-schemat för resursen var:
