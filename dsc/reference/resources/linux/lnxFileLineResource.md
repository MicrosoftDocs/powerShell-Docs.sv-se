...
Det här exemplet visar hur du konfigurerar `/etc/sudoers` filen genom att använda nxFileLine-resursen och se till att användaren: monuser är konfigurerad till inte requiretty.
