...
Du kan använda kommentarbaserad hjälp i DSC-konfigurationer. Användare kan komma åt hjälp genom att anropa funktionen konfiguration med `-?`, eller genom att använda den [Get-Help](https://technet.microsoft.com/en-us/library/hh849696.aspx) cmdlet. Mer information om PowerShell kommentarbaserad hjälp finns [about_Comment_Based_Help](https://technet.microsoft.com/en-us/library/hh847834.aspx).
