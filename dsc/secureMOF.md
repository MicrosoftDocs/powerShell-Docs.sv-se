...
1. **Nyckelanvändning**:
   ...
   - Bör _inte_ innehålla: ”Digital signatur”.
2. **Utökad nyckelanvändning**:
   - Måste innehålla: dokumentkryptering (1.3.6.1.4.1.311.80.1).
   - Bör _inte_ innehålla: klientautentisering (1.3.6.1.5.5.7.3.2) och serverautentisering (1.3.6.1.5.5.7.3.1).
...
Datablocket konfigurationen definierar vilka målnoder att driva på om eller inte för att kryptera autentiseringsuppgifterna, insamling av kryptering och annan information. Mer information om datablocket konfiguration finns i [att avgränsa konfigurations- och miljödata](configData.md).
