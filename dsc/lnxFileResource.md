...
Steg 2: Läsa innehållet i filen i PowerShell-skript med [Get-innehåll](https://technet.microsoft.com/en-us/library/hh849787.aspx) när du har angett den __$OFS__ egenskap som ska användas radbrytningstecken Linux.
