...
Det första steget i att skapa ett schemalagt jobb är som anger när jobbet ska köras. Du kan göra detta genom att skapa och konfigurera ett T:Microsoft.PowerShell.ScheduledJob.ScheduledJobTrigger-objekt. Följande kod skapar en utlösare som schemalägger ett jobb ska köras en gång i framtiden 20 sekunder.
...
Du kan sedan skapa ScheduledJobInvocationInfo och ScheduledJobDefinition objekt för att köra jobbet. Följande kod visar detta.
