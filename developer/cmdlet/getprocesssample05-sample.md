...
Detta exempel visar en fullständig version av cmdleten Get-processen.

## <a name="how-to-build-the-sample-using-visual-studio"></a>Hur du skapar exemplet med Visual Studio.

1. Öppna Windows Explorer och navigera till katalogen GetProcessSample05 under katalogen Samples.

   Navigera till mappen GetProcessSample05 med Windows PowerShell 2.0 SDK för installerade. Standardplatsen är C:\Program Files (x86) \Microsoft SDKs\Windows\v7.0\Samples\sysmgmt\WindowsPowerShell\csharp\GetProcessSample05.
...
3. I den **skapa** menyn och välj **skapa lösning**.
   ...
   Biblioteket för exemplet skapas i \bin eller \bin\debug standardkatalogerna.
...
- Ange positioner för parametrar.

- Anger att parametrar kan ta indata från pipeline. Indata kan hämtas från ett objekt eller ett värde från en egenskap för ett objekt vars egenskapsnamnet är samma som parameternamnet.

- Deklarera en verifieringsattribut för parametern indata.

- Hantering av fel och undantag.

- Felsökningsmeddelanden för skrivning.

## <a name="example"></a>Exempel

Det här exemplet visar hur du skapar en cmdlet som visar en lista över processer som anges.
