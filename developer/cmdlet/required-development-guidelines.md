...
För att göra dessa anrop måste cmdleten ange att den stöder bekräftelse begär Anden genom `SupportsShouldProcess` att ange nyckelordet för cmdlet-attributet. Mer information om hur du anger det här attributet finns i [deklaration av cmdlet-attribut](./cmdlet-attribute-declaration.md).
