...
Detta exempel visar hur du skriver en cmdlet som deklarerar parameteruppsättningar, anger standardparametern anger och kan acceptera en indataobjektet. Denna cmdlet liknar den `Stop-Process` cmdlet som tillhandahålls av Windows PowerShell 2.0.

### <a name="how-to-build-the-sample-by-using-visual-studio"></a>Hur du skapar exemplet med hjälp av Visual Studio.

1. Navigera till mappen StopProcessSample04 med Windows PowerShell 2.0 SDK för installerade. Standardplatsen är C:\Program Files (x86) \Microsoft SDKs\Windows\v7.0\Samples\sysmgmt\WindowsPowerShell\csharp\StopProcessSample04.
...
- Lägger till en parameter som accepterar indataobjektet.

- Att lägga till parametrar till parameteruppsättningar

- Anger standardparameter har angetts.

## <a name="example"></a>Exempel

Följande kod visar en implementering av cmdlet Stop-processen som deklarera parameteruppsättningar, anger standardparametern anger och kan acceptera en indataobjektet.

Detta exempel visar indataobjektet, hur du deklarera parameteruppsättningar och hur du anger standardparametern inställd på att använda.
