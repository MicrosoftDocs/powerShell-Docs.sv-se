...
Detta exempel visar hur du skriver en cmdlet vars parametrar har alias och vars parametrar stöder jokertecken. Denna cmdlet liknar den `Stop-Process` cmdlet som tillhandahålls av Windows PowerShell 2.0.

### <a name="how-to-build-the-sample-by-using-visual-studio"></a>Hur du skapar exemplet med hjälp av Visual Studio.

1. Navigera till mappen StopProcessSample03 med Windows PowerShell 2.0 SDK för installerade. Standardplatsen är C:\Program Files (x86) \Microsoft SDKs\Windows\v7.0\Samples\sysmgmt\WindowsPowerShell\csharp\StopProcessSample03.
...
- Att lägga till alias i parameterdeklarationer...

- Att lägga till stöd för jokertecken till parametrar.

## <a name="example"></a>Exempel

Det här exemplet visar hur du deklarera parameteralias och stöd för jokertecken.
