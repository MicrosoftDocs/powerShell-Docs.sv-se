...
Den här artikeln visar hur du skriver en cmdlet. Den **skicka hälsning** cmdlet tar ett enda användarnamn som indata och sedan skriver en hälsning för denna användare. Även om cmdleten inte gör mycket arbete visar det här exemplet de viktigaste avsnitten av en cmdlet.
