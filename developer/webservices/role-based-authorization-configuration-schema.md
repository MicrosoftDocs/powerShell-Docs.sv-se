...
I [PswsRoleBasedPlugins](https://go.microsoft.com/fwlink/?LinkId=243041) -exemplet används XML-filer för att konfigurera auktoriseringsprincipen. Följande XSD definierar det schema som används för de här filerna.
