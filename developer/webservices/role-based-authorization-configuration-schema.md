...
ms.locfileid: "56851410"
---
# <a name="role-based-authorization-configuration-schema"></a><span data-ttu-id="64d74-102">Konfigurationsschema för rollbaserad auktorisering</span><span class="sxs-lookup"><span data-stu-id="64d74-102">Role-Based Authorization Configuration Schema</span></span>

<span data-ttu-id="64d74-103">Den [PswsRoleBasedPlugins](http://go.microsoft.com/fwlink/?LinkId=243041) exemplet använder XML-filer för att konfigurera principen för auktorisering.</span><span class="sxs-lookup"><span data-stu-id="64d74-103">The [PswsRoleBasedPlugins](http://go.microsoft.com/fwlink/?LinkId=243041) sample uses XML files to configure the authorization policy.</span></span> <span data-ttu-id="64d74-104">Följande XSD definierar ett schema som används för de här filerna.</span><span class="sxs-lookup"><span data-stu-id="64d74-104">The following XSD defines the schema used for these files.</span></span>
