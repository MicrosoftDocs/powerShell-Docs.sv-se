...
ms.locfileid: "56851501"
---
# <a name="resource-mapping-schema"></a><span data-ttu-id="851af-102">Schema för resursmappning</span><span class="sxs-lookup"><span data-stu-id="851af-102">Resource Mapping Schema</span></span>

<span data-ttu-id="851af-103">Management OData IIS Extension använder XML-filer för att definiera mappning.</span><span class="sxs-lookup"><span data-stu-id="851af-103">Management OData IIS Extension uses XML files to define resource mapping.</span></span> <span data-ttu-id="851af-104">Följande XSD definierar ett schema som används för de här filerna.</span><span class="sxs-lookup"><span data-stu-id="851af-104">The following XSD defines the schema used for these files.</span></span>

## <a name="resource-mapping-file-xsd"></a><span data-ttu-id="851af-105">Resursfil mappning XSD</span><span class="sxs-lookup"><span data-stu-id="851af-105">Resource Mapping File XSD</span></span>

<span data-ttu-id="851af-106">Följande XSD definierar schemat för mappning av Management OData IIS Extension resursfiler.</span><span class="sxs-lookup"><span data-stu-id="851af-106">The following XSD defines the schema for Management OData IIS Extension resource mapping files.</span></span>
