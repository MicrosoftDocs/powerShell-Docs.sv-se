---
title: Resursen mappningsschemat | Microsoft Docs
ms.custom: ''
ms.date: 09/12/2016
ms.reviewer: ''
ms.suite: ''
...
ms.locfileid: "62080568"
---
# <a name="resource-mapping-schema"></a><span data-ttu-id="0759f-102">Schema för resursmappning</span><span class="sxs-lookup"><span data-stu-id="0759f-102">Resource Mapping Schema</span></span>

<span data-ttu-id="0759f-103">Management OData IIS Extension använder XML-filer för att definiera mappning.</span><span class="sxs-lookup"><span data-stu-id="0759f-103">Management OData IIS Extension uses XML files to define resource mapping.</span></span> <span data-ttu-id="0759f-104">Följande XSD definierar ett schema som används för de här filerna.</span><span class="sxs-lookup"><span data-stu-id="0759f-104">The following XSD defines the schema used for these files.</span></span>

## <a name="resource-mapping-file-xsd"></a><span data-ttu-id="0759f-105">Resursfil mappning XSD</span><span class="sxs-lookup"><span data-stu-id="0759f-105">Resource Mapping File XSD</span></span>

<span data-ttu-id="0759f-106">Följande XSD definierar schemat för mappning av Management OData IIS Extension resursfiler.</span><span class="sxs-lookup"><span data-stu-id="0759f-106">The following XSD defines the schema for Management OData IIS Extension resource mapping files.</span></span>
