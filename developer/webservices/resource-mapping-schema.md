...
---
# <a name="resource-mapping-schema"></a>Schema för resursmappning

Management OData IIS Extension använder XML-filer för att definiera mappning. Följande XSD definierar ett schema som används för de här filerna.

## <a name="resource-mapping-file-xsd"></a>Resursfil mappning XSD

Följande XSD definierar schemat för mappning av Management OData IIS Extension resursfiler.
