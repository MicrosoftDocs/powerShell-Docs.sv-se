...
---
# <a name="authoring-the-mof-schema-file-for-a-management-odata-web-service"></a>Redigera MOF-schemafilen för en Management OData-webbtjänst

Du definierar de resurser som din Management OData-webbtjänst som exponerar genom att skapa en MOF-fil som används för offentlig resurs-schemat. Varje resurs som har definierats som en klass i filen och egenskaper har definierats som klassmedlemmar. Mer information om ett schema som används i MOF-filen finns i [offentliga Resource schemat](./public-resource-schema.md).

## <a name="example-mof-file"></a>Exempel MOF-filen

Följande fil definierar resurser för tjänsten och processen. Var och en av de här resurserna motsvarar ett objekt som kan hanteras av en uppsättning Windows PowerShell-cmdlet. Egenskaperna motsvarar parametrar som används av dessa cmdlets.

Var och en av de två resurserna innehåller egenskaper av komplexa typen. Komplexa typer som definieras som klasser ändras med den `ComplexType` kvalificerare.
...
[Offentlig resurs Schema](./public-resource-schema.md)