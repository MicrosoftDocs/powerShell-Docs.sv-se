---
title: TypeName-Element för EntrySelectedBy för EnumerableExpansion (Format) | Microsoft Docs
ms.custom: ''
ms.date: 09/13/2016
ms.reviewer: ''
ms.suite: ''
...
Anger en .NET-typ som utökas av denna definition. Det här elementet används när du definierar en standardinställningarna.

Elementet (Format) DefaultSettings Element (Format) EnumerableExpansions Element (Format) EnumerableExpansion Element (Format) EntrySelectedBy konfigurationselement för EnumerableExpansion (Format) TypeName-elementet för EntrySelectedBy för EnumerableExpansion (Format)
