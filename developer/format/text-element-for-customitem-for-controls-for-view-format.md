...
---
# <a name="text-element-for-customitem-for-controls-for-view-format"></a>Text-element för CustomItem för Controls för View (format)

Anger text som läggs till i de data som visas av kontroll, till exempel en etikett, hakparenteser för att skriva data och blanksteg dra in data. Det här elementet används när du definierar kontroller som kan användas av en vy.
