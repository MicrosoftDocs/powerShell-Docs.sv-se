...
Anger att text som överskrider kolumnbredden visas på nästa rad. Som standard trunkeras text som överskrider kolumnbredden.

Elementet (Format) ViewDefinitions Element (Format) visa Element (Format) TableControl Element (Format) TableRowEntries konfigurationselement för TableControl (Format) TableRowEntry elementet för TableRowEntries för TableControl (Format) radbyte elementet för TableRowEntry för TableControl (Format)
...
I följande avsnitt beskrivs attribut, underordnade element och överordnade element i den `Wrap` element.
