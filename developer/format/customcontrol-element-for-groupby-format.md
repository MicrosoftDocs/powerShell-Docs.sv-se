...
Elementet (Format) ViewDefinitions Element (Format) visa Element (Format) GroupBy konfigurationselement för Visa (Format) anpassad kontroll elementet för GroupBy (Format)
...
I följande avsnitt beskrivs de attribut och underordnade element överordnade elementet i den `CustomControl` element. Du kan ange valfritt antal underordnade element och lista dem i valfri ordning.
...
|Element|Beskrivning|
|-------------|-----------------|
|[CustomEntries Element för anpassad kontroll för GroupBy (Format)](./customentries-element-for-customcontrol-for-groupby-format.md)|Element som krävs.<br /><br /> Innehåller definitioner för kontrollen.|
