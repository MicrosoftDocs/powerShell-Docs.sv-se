...
Det här exemplet visar hur du skapar en interaktiv konsol-baserad värd-App som läser kommandon från kommandoraden, kör kommandona och visar resultatet i konsolen. Det här exemplet använder dessutom Tokenizer-API: er för att ange färgen på texten som anges av användaren.

## <a name="requirements"></a>Krav

- Det här exemplet kräver Windows PowerShell 2.0.

- Det här programmet måste köras med förhöjd (Kör som administratör).

## <a name="demonstrates"></a>Visar

- Skapa en anpassad värd vars klasser som härleds från den [System.Management.Automation.Host.PSHost](/dotnet/api/System.Management.Automation.Host.PSHost) klass, den [System.Management.Automation.Host.Pshostuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface) klassen och [System.Management.Automation.Host.Pshostrawuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface) klass.

- Att skapa ett konsolprogram som använder dessa värden klasser för att skapa ett interaktivt Windows PowerShell-gränssnitt.

- Skapa en `$profile` variabeln och läser in följande profiler.

  - aktuell användare, aktuella värden

  - aktuell användare, alla värdar

  - alla användare, aktuella värden

  - alla användare, alla värdar

- Implementera de [System.Management.Automation.Host.Ihostuisupportsmultiplechoiceselection](/dotnet/api/System.Management.Automation.Host.IHostUISupportsMultipleChoiceSelection) gränssnitt.

- Implementera de [System.Management.Automation.Host.Ihostsupportsinteractivesession](/dotnet/api/System.Management.Automation.Host.IHostSupportsInteractiveSession) gränssnittet för att stödja interaktiva fjärrkommunikation med hjälp av den [Enter-PsSession](/powershell/module/Microsoft.PowerShell.Core/Enter-PSSession) och [ Avsluta-PsSession](/powershell/module/Microsoft.PowerShell.Core/Exit-PSSession) cmdletar.

- Använd Tokenize API för att Färglägg kommandoraden när det anges.

## <a name="example"></a>Exempel

 Det här exemplet används att ange kommandon i Kommandotolken, bearbetar dessa kommandon och skriver sedan ut resultaten.
...
## <a name="example"></a>Exempel
 ...
 Följande kod är implementeringen av den [System.Management.Automation.Host.PSHost](/dotnet/api/System.Management.Automation.Host.PSHost) klass som används av den här värdprogrammet. De element som inte har implementerats utlöser ett undantag eller returnera någonting.
...
## <a name="example"></a>Exempel
 ...
 Följande kod är implementeringen av den [System.Management.Automation.Host.Pshostuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface) klass som används av den här värdprogrammet.
...
## <a name="example"></a>Exempel
 ...
 Följande kod är implementeringen av den [System.Management.Automation.Host.Pshostrawuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface) klass som används av den här värdprogrammet. De element som inte har implementerats utlöser ett undantag eller returnera någonting.
...
## <a name="example"></a>Exempel
 ...
 Följande kod läser från kommandoraden och färger texten när det anges. Token bestäms genom att använda den [System.Management.Automation.Psparser.Tokenize*](/dotnet/api/System.Management.Automation.PSParser.Tokenize) metod.
