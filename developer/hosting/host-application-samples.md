...
Innehåller exempelkod för att skriva en egen värd. Värden är en komponent i Windows PowerShell som upprättar kommunikation mellan användaren och Windows PowerShell-motorn. Mer information om anpassade värdar finns i [anpassade värden] (https://msdn.microsoft.com/en-us/library/ee706563(v=vs.85).
...
Innehåller exempelkod för att skapa körningsutrymmen. Mer information om hur körningsutrymmen används finns i [värd programmet Körningsutrymmen] (https://msdn.microsoft.com/en-us/library/ee706563(v=vs.85).
