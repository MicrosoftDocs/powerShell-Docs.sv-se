...
|Språk|Ämne|
|--------------|-----------|
|C#|[StopProc04 (C#) exempelkoden](./stopprocesssample04-csharp-sample-code.md)|
|VB.NET|[StopProc04 (VB.NET) exempelkod](./stopprocesssample04-vb-net-sample-code.md)|
