---
title: GetProc05 (VB.NET) exempelkoden | Microsoft Docs
ms.custom: ''
ms.date: 09/13/2016
ms.reviewer: ''
ms.suite: ''
...
ms.locfileid: "56845068"
---
# <a name="getproc05-vbnet-sample-code"></a><span data-ttu-id="75899-102">GetProc05 (VB.NET) – kodexempel</span><span class="sxs-lookup"><span data-stu-id="75899-102">GetProc05 (VB.NET) Sample Code</span></span>

<span data-ttu-id="75899-103">Här är den fullständiga VB.NET-koden för GetProc05 exempel-cmdlet.</span><span class="sxs-lookup"><span data-stu-id="75899-103">Here is the complete VB.NET code for the GetProc05 sample cmdlet.</span></span>
...
## <a name="see-also"></a><span data-ttu-id="75899-104">Se även</span><span class="sxs-lookup"><span data-stu-id="75899-104">See Also</span></span>

[<span data-ttu-id="75899-105">Windows PowerShell SDK</span><span class="sxs-lookup"><span data-stu-id="75899-105">Windows PowerShell SDK</span></span>](../windows-powershell-reference.md)