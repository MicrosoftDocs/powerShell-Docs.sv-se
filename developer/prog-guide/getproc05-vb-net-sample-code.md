...
ms.locfileid: "62081690"
---
# <a name="getproc05-vbnet-sample-code"></a><span data-ttu-id="1dfd2-102">GetProc05 (VB.NET) – kodexempel</span><span class="sxs-lookup"><span data-stu-id="1dfd2-102">GetProc05 (VB.NET) Sample Code</span></span>

<span data-ttu-id="1dfd2-103">Här är den fullständiga VB.NET-koden för GetProc05 exempel-cmdlet.</span><span class="sxs-lookup"><span data-stu-id="1dfd2-103">Here is the complete VB.NET code for the GetProc05 sample cmdlet.</span></span>
...
## <a name="see-also"></a><span data-ttu-id="1dfd2-104">Se även</span><span class="sxs-lookup"><span data-stu-id="1dfd2-104">See Also</span></span>

[<span data-ttu-id="1dfd2-105">Windows PowerShell SDK</span><span class="sxs-lookup"><span data-stu-id="1dfd2-105">Windows PowerShell SDK</span></span>](../windows-powershell-reference.md)