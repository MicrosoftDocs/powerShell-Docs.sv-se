...
Här är VB.NET källkoden för Runspace02-exemplet. Det här exemplet används den [System.Management.Automation.Runspaceinvoke](/dotnet/api/System.Management.Automation.RunspaceInvoke) klassen för att köra den `Get-Process` cmdlet synkront. Windows-formulär och databindning används sedan för att visa resultatet i en DataGridView-kontroll.
