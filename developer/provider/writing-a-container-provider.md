...
Det här avsnittet beskriver hur du implementerar metoderna i en Windows PowerShell-providern som har stöd för objekt som innehåller andra objekt, till exempel mappar i filsystemprovidern. För att kunna stödja behållare, en leverantör måste komma från den [System.Management.Automation.Provider.Containercmdletprovider](/dotnet/api/System.Management.Automation.Provider.ContainerCmdletProvider) klass.

Providern i exemplen i det här avsnittet använder en Access-databas som dess datalager. Det finns flera hjälpmetoder och klasser som används för att interagera med databasen. Hela exemplet som innehåller helper-metoder, se [AccessDBProviderSample04](./accessdbprovidersample04.md).
...
Deklarera providern kan härledas från den [System.Management.Automation.Provider.Containercmdletprovider](/dotnet/api/System.Management.Automation.Provider.ContainerCmdletProvider) klassen och anpassa den med den [System.Management.Automation.Provider.Cmdletproviderattribute ](/dotnet/api/System.Management.Automation.Provider.CmdletProviderAttribute).
...
Den [System.Management.Automation.Provider.Containercmdletprovider.Getchildnames*](/dotnet/api/System.Management.Automation.Provider.ContainerCmdletProvider.GetChildNames) metoden liknar den [System.Management.Automation.Provider.Containercmdletprovider.Getchilditems*](/dotnet/api/System.Management.Automation.Provider.ContainerCmdletProvider.GetChildItems) metod, förutom att den returnerar endast namnegenskapen för objekt och inte själva objekt.
...
En typisk verkliga-provider kan flytta objekt från en sökväg till en annan i enheten. Ett exempel på en provider som stöder flytta objekt, se [skriva en leverantör av navigering](./writing-a-navigation-provider.md).
