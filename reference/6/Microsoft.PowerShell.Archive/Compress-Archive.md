...
- Om du vill skapa ett arkiv som **innehåller** rot katalogen och alla dess filer och under kataloger, anger du rot katalogen i **sökvägen** utan jokertecken. Exempelvis: `-Path C:\Reference`
- Om du vill skapa ett arkiv som **undantar** rot katalogen, men zips alla filer och under kataloger, använder du jokertecknet asterisk ( `*` ). Exempelvis: `-Path C:\Reference\*`
- Om du vill skapa ett arkiv som endast zips filerna i rot katalogen använder du jokertecknet **Star-dot-Star** ( `*.*` ). Under kataloger i roten ingår inte i arkivet. Exempelvis: `-Path C:\Reference\*.*`
