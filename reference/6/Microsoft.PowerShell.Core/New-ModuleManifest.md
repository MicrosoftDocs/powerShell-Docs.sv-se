...
`New-ModuleManifest` skapar modul manifest ( `.psd1` )-filer som kodas enligt följande:

- PowerShell 6,0 som körs på Windows använder **UTF16**.
- PowerShell 6,0 som körs på plattformar som inte är från Windows använder **UTF8NoBOM**.
- PowerShell 6,1 och högre som körs på Windows-och icke-Windows-plattformar använder **UTF8NoBOM**.
