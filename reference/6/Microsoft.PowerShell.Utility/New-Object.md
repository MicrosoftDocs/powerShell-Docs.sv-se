...
Anger en matris med argument som ska skickas till konstruktorn för klassen .NET Framework. Om konstruktorn använder en enda parameter som är en matris måste du figursätta den parametern inuti en annan matris. Ett exempel:
