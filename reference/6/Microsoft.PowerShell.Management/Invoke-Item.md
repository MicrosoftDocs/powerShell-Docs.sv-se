...
Detta kommando öppnar alla Microsoft Office Excel-kalkylblad i `C:\Documents and
Settings\Lister\My Documents` mappen. Varje kalkyl blad öppnas i en ny instans av Excel.
I detta fall är standard åtgärden för filer som öppnas i Excel `.xls` .
