...
`Save-Package` använder parametern **Name** för att ange paketet. Paketet hämtas från den lagrings plats som anges av parametern **ProviderName** . Parametern **Path** bestämmer var paketet sparas.
