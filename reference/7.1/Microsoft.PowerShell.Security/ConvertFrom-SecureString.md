...
### Exempel 4: konvertera en säker sträng direkt till en oformaterad text sträng
...
När det här alternativet är inställt `ConvertFrom-SecureString` konverteras säkra strängar till den dekrypterade klartext-strängen som utdata.

Den här parameter lades till i PowerShell 7,0.
