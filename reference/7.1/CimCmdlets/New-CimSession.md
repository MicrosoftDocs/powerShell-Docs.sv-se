...
Du kan använda namnet för att referera till CIM-sessionen när du använder andra cmdlets, till exempel cmdleten [Get-CimSession](Get-CimSession.md) .
...
Anger nätverks porten på den fjärrdator som används för den här anslutningen. Om du vill ansluta till en fjärrdator måste fjärrdatorn Lyssna på porten som anslutningen använder. Standard portarna är 5985 (WinRM-porten för HTTP) och 5986 (WinRM-porten för HTTPS).
