...
### <span data-ttu-id="4c5d9-109">Session</span><span class="sxs-lookup"><span data-stu-id="4c5d9-109">Session</span></span>
...
### <span data-ttu-id="4c5d9-119">Hålla</span><span class="sxs-lookup"><span data-stu-id="4c5d9-119">ContainerId</span></span>
...
<span data-ttu-id="4c5d9-151">Som svar begär PowerShell lösen ordet och en autentiseringsmetod för user01-kontot.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-151">In response, PowerShell requests the password and an authentication method for the User01 account.</span></span>
...
### <span data-ttu-id="4c5d9-207">Exempel 9: inkludera lokala variabler i en kommando körning på en fjärran sluten dator</span><span class="sxs-lookup"><span data-stu-id="4c5d9-207">Example 9: Include local variables in a command run on a remote computer</span></span>
...
### <span data-ttu-id="4c5d9-327">– Argument List</span><span class="sxs-lookup"><span data-stu-id="4c5d9-327">-ArgumentList</span></span>
...
### <span data-ttu-id="4c5d9-339">– AsJob</span><span class="sxs-lookup"><span data-stu-id="4c5d9-339">-AsJob</span></span>
...
### <span data-ttu-id="4c5d9-350">-Autentisering</span><span class="sxs-lookup"><span data-stu-id="4c5d9-350">-Authentication</span></span>
...
<span data-ttu-id="4c5d9-385">Anger den sessionsinformation som används för den nya **PSSession**.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-385">Specifies the session configuration that is used for the new **PSSession**.</span></span>
...
### <span data-ttu-id="4c5d9-395">-ConnectionUri</span><span class="sxs-lookup"><span data-stu-id="4c5d9-395">-ConnectionUri</span></span>

<span data-ttu-id="4c5d9-396">Anger en Uniform Resource Identifier (URI) som definierar sessionens anslutnings slut punkt.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-396">Specifies a Uniform Resource Identifier (URI) that defines the connection endpoint of the session.</span></span>
<span data-ttu-id="4c5d9-397">URI: n måste vara fullständigt kvalificerad.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-397">The URI must be fully qualified.</span></span>

<span data-ttu-id="4c5d9-398">Formatet för den här strängen är följande:</span><span class="sxs-lookup"><span data-stu-id="4c5d9-398">The format of this string is as follows:</span></span>

`<Transport>://<ComputerName>:<Port>/<ApplicationName>`

<span data-ttu-id="4c5d9-399">Standardvärdet är följande:</span><span class="sxs-lookup"><span data-stu-id="4c5d9-399">The default value is as follows:</span></span>

`http://localhost:5985/WSMAN`

<span data-ttu-id="4c5d9-400">Om du inte anger en anslutnings-URI kan du använda parametrarna **UseSSL** och **port** för att ange anslutnings-URI-värden.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-400">If you don't specify a connection URI, you can use the **UseSSL** and **Port** parameters to specify the connection URI values.</span></span>

<span data-ttu-id="4c5d9-401">Giltiga värden för URI: n i **transport** segmentet är http och https.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-401">Valid values for the **Transport** segment of the URI are HTTP and HTTPS.</span></span> <span data-ttu-id="4c5d9-402">Om du anger en anslutnings-URI med ett transport segment, men inte anger någon port, skapas sessionen med standard portarna: 80 för HTTP och 443 för HTTPS.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-402">If you specify a connection URI with a Transport segment, but don't specify a port, the session is created with the standards ports: 80 for HTTP and 443 for HTTPS.</span></span> <span data-ttu-id="4c5d9-403">Om du vill använda standard portarna för PowerShell-fjärrkommunikation anger du Port 5985 för HTTP eller 5986 för HTTPS.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-403">To use the default ports for PowerShell remoting, specify port 5985 for HTTP or 5986 for HTTPS.</span></span>

<span data-ttu-id="4c5d9-404">Om mål datorn omdirigerar anslutningen till en annan URI, förhindrar PowerShell omdirigeringen om du inte använder parametern **AllowRedirection** i kommandot.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-404">If the destination computer redirects the connection to a different URI, PowerShell prevents the redirection unless you use the **AllowRedirection** parameter in the command.</span></span>
...
### <span data-ttu-id="4c5d9-405">-ContainerId</span><span class="sxs-lookup"><span data-stu-id="4c5d9-405">-ContainerId</span></span>

<span data-ttu-id="4c5d9-406">Anger en matris med container-ID: n.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-406">Specifies an array of container IDs.</span></span>
...
### <span data-ttu-id="4c5d9-407">-Credential</span><span class="sxs-lookup"><span data-stu-id="4c5d9-407">-Credential</span></span>

<span data-ttu-id="4c5d9-408">Anger ett användar konto som har behörighet att utföra den här åtgärden.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-408">Specifies a user account that has permission to perform this action.</span></span> <span data-ttu-id="4c5d9-409">Standard är den aktuella användaren.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-409">The default is the current user.</span></span>

<span data-ttu-id="4c5d9-410">Ange ett användar namn, till exempel **user01** eller **Domain01\User01** , eller ange ett **PSCredential** -objekt som genererats av `Get-Credential` cmdleten.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-410">Type a user name, such as **User01** or **Domain01\User01** , or enter a **PSCredential** object generated by the `Get-Credential` cmdlet.</span></span> <span data-ttu-id="4c5d9-411">Om du anger ett användar namn uppmanas du att ange lösen ordet.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-411">If you type a user name, you're prompted to enter the password.</span></span>

<span data-ttu-id="4c5d9-412">Autentiseringsuppgifterna lagras i ett [PSCredential](/dotnet/api/system.management.automation.pscredential) -objekt och lösen ordet lagras som en [SecureString](/dotnet/api/system.security.securestring).</span><span class="sxs-lookup"><span data-stu-id="4c5d9-412">Credentials are stored in a [PSCredential](/dotnet/api/system.management.automation.pscredential) object and the password is stored as a [SecureString](/dotnet/api/system.security.securestring).</span></span>

> [!NOTE]
> <span data-ttu-id="4c5d9-413">Mer information om **SecureString** -data skydd finns i [hur säker är SecureString?](/dotnet/api/system.security.securestring#how-secure-is-securestring).</span><span class="sxs-lookup"><span data-stu-id="4c5d9-413">For more information about **SecureString** data protection, see [How secure is SecureString?](/dotnet/api/system.security.securestring#how-secure-is-securestring).</span></span>
...
### <span data-ttu-id="4c5d9-414">-EnableNetworkAccess</span><span class="sxs-lookup"><span data-stu-id="4c5d9-414">-EnableNetworkAccess</span></span>

<span data-ttu-id="4c5d9-415">Anger att denna cmdlet lägger till en interaktiv säkerhetstoken till loopback-sessioner.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-415">Indicates that this cmdlet adds an interactive security token to loopback sessions.</span></span> <span data-ttu-id="4c5d9-416">Med den interaktiva token kan du köra kommandon i loopback-sessionen som hämtar data från andra datorer.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-416">The interactive token lets you run commands in the loopback session that get data from other computers.</span></span> <span data-ttu-id="4c5d9-417">Du kan till exempel köra ett kommando i sessionen som kopierar XML-filer från en fjärrdator till den lokala datorn.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-417">For example, you can run a command in the session that copies XML files from a remote computer to the local computer.</span></span>

<span data-ttu-id="4c5d9-418">En loopback-session är en **PSSession** som kommer från och slutar på samma dator.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-418">A loopback session is a **PSSession** that originates and ends on the same computer.</span></span> <span data-ttu-id="4c5d9-419">Om du vill skapa en loopback-session utelämnar du parametern **computername** eller anger värdet till punkt ( `.` ), localhost eller namnet på den lokala datorn.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-419">To create a loopback session, omit the **ComputerName** parameter or set its value to dot (`.`), localhost, or the name of the local computer.</span></span>

<span data-ttu-id="4c5d9-420">Som standard skapas loopback-sessioner med en nätverks-token som kanske inte ger behörighet att autentisera till fjärrdatorer.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-420">By default, loopback sessions are created using a network token, which might not provide sufficient permission to authenticate to remote computers.</span></span>

<span data-ttu-id="4c5d9-421">Parametern **EnableNetworkAccess** är endast effektiv i loopback-sessioner.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-421">The **EnableNetworkAccess** parameter is effective only in loopback sessions.</span></span> <span data-ttu-id="4c5d9-422">Om du använder **EnableNetworkAccess** när du skapar en-session på en fjärrdator, lyckas kommandot, men parametern ignoreras.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-422">If you use **EnableNetworkAccess** when you create a session on a remote computer, the command succeeds, but the parameter is ignored.</span></span>

<span data-ttu-id="4c5d9-423">Du kan tillåta fjärråtkomst i en loopback-session med hjälp av **CredSSP** -värdet för parametern **Authentication** , som delegerar autentiseringsuppgifterna för sessionen till andra datorer.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-423">You can allow remote access in a loopback session using the **CredSSP** value of the **Authentication** parameter, which delegates the session credentials to other computers.</span></span>

<span data-ttu-id="4c5d9-424">För att skydda datorn från skadlig åtkomst kan frånkopplade loopback-sessioner som har interaktiva tokens, som är de som skapats med **EnableNetworkAccess** , bara återanslutas från den dator där sessionen skapades.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-424">To protect the computer from malicious access, disconnected loopback sessions that have interactive tokens, which are those created using **EnableNetworkAccess** , can be reconnected only from the computer on which the session was created.</span></span> <span data-ttu-id="4c5d9-425">Frånkopplade sessioner som använder CredSSP-autentisering kan återanslutas från andra datorer.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-425">Disconnected sessions that use CredSSP authentication can be reconnected from other computers.</span></span> <span data-ttu-id="4c5d9-426">Mer information finns i `Disconnect-PSSession`.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-426">For more information, see `Disconnect-PSSession`.</span></span>

<span data-ttu-id="4c5d9-427">Den här parametern introducerades i PowerShell 3,0.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-427">This parameter was introduced in PowerShell 3.0.</span></span>
...
### <span data-ttu-id="4c5d9-428">-Sökväg</span><span class="sxs-lookup"><span data-stu-id="4c5d9-428">-FilePath</span></span>

<span data-ttu-id="4c5d9-429">Anger ett lokalt skript som denna cmdlet körs på en eller flera fjärrdatorer.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-429">Specifies a local script that this cmdlet runs on one or more remote computers.</span></span> <span data-ttu-id="4c5d9-430">Ange sökvägen och fil namnet för skriptet eller skicka en sökväg till en skript Sök väg till `Invoke-Command` .</span><span class="sxs-lookup"><span data-stu-id="4c5d9-430">Enter the path and filename of the script, or pipe a script path to `Invoke-Command`.</span></span> <span data-ttu-id="4c5d9-431">Skriptet måste finnas på den lokala datorn eller i en katalog som den lokala datorn kan komma åt.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-431">The script must exist on the local computer or in a directory that the local computer can access.</span></span> <span data-ttu-id="4c5d9-432">Använd **argument List** för att ange värden för parametrarna i skriptet.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-432">Use **ArgumentList** to specify the values of parameters in the script.</span></span>

<span data-ttu-id="4c5d9-433">När du använder den här parametern konverterar PowerShell innehållet i den angivna skript filen till ett-skript block, skickar skript blocket till fjärrdatorn och kör det på fjärrdatorn.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-433">When you use this parameter, PowerShell converts the contents of the specified script file to a script block, transmits the script block to the remote computer, and runs it on the remote computer.</span></span>
...
### <span data-ttu-id="4c5d9-434">-HideComputerName</span><span class="sxs-lookup"><span data-stu-id="4c5d9-434">-HideComputerName</span></span>

<span data-ttu-id="4c5d9-435">Anger att denna cmdlet utelämnar dator namnet för varje objekt från visningen av utdata.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-435">Indicates that this cmdlet omits the computer name of each object from the output display.</span></span> <span data-ttu-id="4c5d9-436">Som standard visas namnet på den dator som skapade objektet i visningen.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-436">By default, the name of the computer that generated the object appears in the display.</span></span>

<span data-ttu-id="4c5d9-437">Den här parametern påverkar endast visningen av utdata.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-437">This parameter affects only the output display.</span></span> <span data-ttu-id="4c5d9-438">Objektet ändras inte.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-438">It doesn't change the object.</span></span>
...
### <span data-ttu-id="4c5d9-439">-HostName</span><span class="sxs-lookup"><span data-stu-id="4c5d9-439">-HostName</span></span>

<span data-ttu-id="4c5d9-440">Anger en matris med dator namn för en SSH-baserad (Secure Shell) anslutning.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-440">Specifies an array of computer names for a Secure Shell (SSH) based connection.</span></span> <span data-ttu-id="4c5d9-441">Detta liknar parametern **computername** , förutom att anslutningen till fjärrdatorn görs med SSH i stället för Windows WinRM.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-441">This is similar to the **ComputerName** parameter except that the connection to the remote computer is made using SSH rather than Windows WinRM.</span></span>

<span data-ttu-id="4c5d9-442">Den här parametern introducerades i PowerShell 6,0.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-442">This parameter was introduced in PowerShell 6.0.</span></span>
...
### <span data-ttu-id="4c5d9-443">-InDisconnectedSession</span><span class="sxs-lookup"><span data-stu-id="4c5d9-443">-InDisconnectedSession</span></span>

<span data-ttu-id="4c5d9-444">Anger att denna cmdlet kör ett kommando eller skript i en frånkopplad session.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-444">Indicates that this cmdlet runs a command or script in a disconnected session.</span></span>

<span data-ttu-id="4c5d9-445">När du använder parametern **InDisconnectedSession** `Invoke-Command` skapar en beständig session på varje fjärrdator, startar kommandot som anges av parametern **script block** eller **sökväg** och kopplar sedan från sessionen.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-445">When you use the **InDisconnectedSession** parameter, `Invoke-Command` creates a persistent session on each remote computer, starts the command specified by the **ScriptBlock** or **FilePath** parameter, and then disconnects from the session.</span></span> <span data-ttu-id="4c5d9-446">Kommandona fortsätter att köras i de frånkopplade sessionerna.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-446">The commands continue to run in the disconnected sessions.</span></span> <span data-ttu-id="4c5d9-447">Med **InDisconnectedSession** kan du köra kommandon utan att ha en anslutning till fjärrsessionerna.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-447">**InDisconnectedSession** enables you to run commands without maintaining a connection to the remote sessions.</span></span> <span data-ttu-id="4c5d9-448">Eftersom sessionen kopplas bort innan ett resultat returneras, ser **InDisconnectedSession** till att alla kommando resultat returneras till den återanslutna sessionen, i stället för att delas mellan sessioner.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-448">And, because the session is disconnected before any results are returned, **InDisconnectedSession** makes sure that all command results are returned to the reconnected session, instead of being split between sessions.</span></span>

<span data-ttu-id="4c5d9-449">Du kan inte använda **InDisconnectedSession** med parametern **session** eller parametern **AsJob** .</span><span class="sxs-lookup"><span data-stu-id="4c5d9-449">You can't use **InDisconnectedSession** with the **Session** parameter or the **AsJob** parameter.</span></span>

<span data-ttu-id="4c5d9-450">Kommandon som använder **InDisconnectedSession** returnerar ett **PSSession** -objekt som representerar den frånkopplade sessionen.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-450">Commands that use **InDisconnectedSession** return a **PSSession** object that represents the disconnected session.</span></span> <span data-ttu-id="4c5d9-451">De returnerar inte kommandoutdata.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-451">They don't return the command output.</span></span> <span data-ttu-id="4c5d9-452">Använd cmdletarna eller för att ansluta till den frånkopplade `Connect-PSSession` sessionen `Receive-PSSession` .</span><span class="sxs-lookup"><span data-stu-id="4c5d9-452">To connect to the disconnected session, use the `Connect-PSSession` or `Receive-PSSession` cmdlets.</span></span> <span data-ttu-id="4c5d9-453">Använd cmdleten för att hämta resultatet av de kommandon som kördes i sessionen `Receive-PSSession` .</span><span class="sxs-lookup"><span data-stu-id="4c5d9-453">To get the results of commands that ran in the session, use the `Receive-PSSession` cmdlet.</span></span> <span data-ttu-id="4c5d9-454">Om du vill köra kommandon som genererar utdata i en frånkopplad session anger du värdet för alternativet **OutputBufferingMode** session som du vill **ta bort**.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-454">To run commands that generate output in a disconnected session, set the value of the **OutputBufferingMode** session option to **Drop**.</span></span> <span data-ttu-id="4c5d9-455">Om du vill ansluta till den frånkopplade sessionen ställer du in tids gränsen för inaktivitet i sessionen så att den ger tillräckligt med tid för att ansluta innan sessionen tas bort.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-455">If you intend to connect to the disconnected session, set the idle time-out in the session so that it provides sufficient time for you to connect before deleting the session.</span></span>

<span data-ttu-id="4c5d9-456">Du kan ställa in buffrings läget för utdata och tids gränsen för inaktivitet i parametern **SessionOption** eller i `$PSSessionOption` variabeln Preference.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-456">You can set the output buffering mode and idle time-out in the **SessionOption** parameter or in the `$PSSessionOption` preference variable.</span></span> <span data-ttu-id="4c5d9-457">Mer information om sessions alternativ finns i `New-PSSessionOption` och [about_Preference_Variables](./about/about_preference_variables.md).</span><span class="sxs-lookup"><span data-stu-id="4c5d9-457">For more information about session options, see `New-PSSessionOption` and [about_Preference_Variables](./about/about_preference_variables.md).</span></span>

<span data-ttu-id="4c5d9-458">Mer information om funktionen frånkopplade sessioner finns [about_Remote_Disconnected_Sessions](about/about_Remote_Disconnected_Sessions.md).</span><span class="sxs-lookup"><span data-stu-id="4c5d9-458">For more information about the Disconnected Sessions feature, see [about_Remote_Disconnected_Sessions](about/about_Remote_Disconnected_Sessions.md).</span></span>

<span data-ttu-id="4c5d9-459">Den här parametern introducerades i PowerShell 3,0.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-459">This parameter was introduced in PowerShell 3.0.</span></span>
...
### <span data-ttu-id="4c5d9-460">– InputObject</span><span class="sxs-lookup"><span data-stu-id="4c5d9-460">-InputObject</span></span>

<span data-ttu-id="4c5d9-461">Anger ininformation till kommandot.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-461">Specifies input to the command.</span></span> <span data-ttu-id="4c5d9-462">Ange en variabel som innehåller objekten eller Skriv ett kommando eller uttryck som hämtar objekten.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-462">Enter a variable that contains the objects or type a command or expression that gets the objects.</span></span>

<span data-ttu-id="4c5d9-463">När du använder **InputObject** -parametern använder du den `$Input` automatiska variabeln i värdet för parametern **script block** för att representera de ingående objekten.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-463">When using the **InputObject** parameter, use the `$Input` automatic variable in the value of the **ScriptBlock** parameter to represent the input objects.</span></span>
...
### <span data-ttu-id="4c5d9-464">– JobName</span><span class="sxs-lookup"><span data-stu-id="4c5d9-464">-JobName</span></span>

<span data-ttu-id="4c5d9-465">Anger ett eget namn för bakgrunds jobbet.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-465">Specifies a friendly name for the background job.</span></span> <span data-ttu-id="4c5d9-466">Som standard namnges jobb `Job<n>` , där `<n>` är ett ordnings tal.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-466">By default, jobs are named `Job<n>`, where `<n>` is an ordinal number.</span></span>

<span data-ttu-id="4c5d9-467">Om du använder parametern **JobName** i ett kommando körs kommandot som ett jobb och `Invoke-Command` returnerar ett jobb objekt, även om du inte inkluderar **AsJob** i kommandot.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-467">If you use the **JobName** parameter in a command, the command is run as a job, and `Invoke-Command` returns a job object, even if you don't include **AsJob** in the command.</span></span>

<span data-ttu-id="4c5d9-468">Mer information om PowerShell-bakgrunds jobb finns [about_Jobs](./About/about_Jobs.md).</span><span class="sxs-lookup"><span data-stu-id="4c5d9-468">For more information about PowerShell background jobs, see [about_Jobs](./About/about_Jobs.md).</span></span>
...
### <span data-ttu-id="4c5d9-469">-Fil Sök väg</span><span class="sxs-lookup"><span data-stu-id="4c5d9-469">-KeyFilePath</span></span>

<span data-ttu-id="4c5d9-470">Anger en nyckel fil Sök väg som används av SSH (Secure Shell) för att autentisera en användare på en fjärrdator.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-470">Specifies a key file path used by Secure Shell (SSH) to authenticate a user on a remote computer.</span></span>

<span data-ttu-id="4c5d9-471">SSH tillåter att användarautentisering utförs via privata och offentliga nycklar som ett alternativ till grundläggande lösenordsautentisering.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-471">SSH allows user authentication to be performed via private and public keys as an alternative to basic password authentication.</span></span> <span data-ttu-id="4c5d9-472">Om fjärrdatorn har kon figurer ATS för nyckel autentisering kan du använda den här parametern för att ange den nyckel som identifierar användaren.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-472">If the remote computer is configured for key authentication, then this parameter can be used to provide the key that identifies the user.</span></span>

<span data-ttu-id="4c5d9-473">Den här parametern introducerades i PowerShell 6,0.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-473">This parameter was introduced in PowerShell 6.0.</span></span>
...
### <span data-ttu-id="4c5d9-474">-NoNewScope</span><span class="sxs-lookup"><span data-stu-id="4c5d9-474">-NoNewScope</span></span>

<span data-ttu-id="4c5d9-475">Anger att denna cmdlet kör det angivna kommandot i det aktuella omfånget.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-475">Indicates that this cmdlet runs the specified command in the current scope.</span></span> <span data-ttu-id="4c5d9-476">Som standard `Invoke-Command` Kör kommandon i deras egna omfång.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-476">By default, `Invoke-Command` runs commands in their own scope.</span></span>

<span data-ttu-id="4c5d9-477">Den här parametern är endast giltig i kommandon som körs i den aktuella sessionen, det vill säga kommandon som utelämnar både **computername** -och **session** -parametrarna.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-477">This parameter is valid only in commands that are run in the current session, that is, commands that omit both the **ComputerName** and **Session** parameters.</span></span>

<span data-ttu-id="4c5d9-478">Den här parametern introducerades i PowerShell 3,0.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-478">This parameter was introduced in PowerShell 3.0.</span></span>
...
### <span data-ttu-id="4c5d9-479">-Port</span><span class="sxs-lookup"><span data-stu-id="4c5d9-479">-Port</span></span>

<span data-ttu-id="4c5d9-480">Anger nätverks porten på den fjärrdator som används för det här kommandot.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-480">Specifies the network port on the remote computer that is used for this command.</span></span> <span data-ttu-id="4c5d9-481">Om du vill ansluta till en fjärrdator måste fjärrdatorn Lyssna på porten som anslutningen använder.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-481">To connect to a remote computer, the remote computer must be listening on the port that the connection uses.</span></span> <span data-ttu-id="4c5d9-482">Standard portarna är 5985 (WinRM-port för HTTP) och 5986 (WinRM-port för HTTPS).</span><span class="sxs-lookup"><span data-stu-id="4c5d9-482">The default ports are 5985 (WinRM port for HTTP) and 5986 (WinRM port for HTTPS).</span></span>

<span data-ttu-id="4c5d9-483">Innan du använder en alternativ port konfigurerar du WinRM-lyssnaren på fjärrdatorn för att lyssna på den porten.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-483">Before using an alternate port, configure the WinRM listener on the remote computer to listen at that port.</span></span> <span data-ttu-id="4c5d9-484">Konfigurera lyssnaren genom att skriva följande två kommandon i PowerShell-prompten:</span><span class="sxs-lookup"><span data-stu-id="4c5d9-484">To configure the listener, type the following two commands at the PowerShell prompt:</span></span>

`Remove-Item -Path WSMan:\Localhost\listener\listener* -Recurse`

`New-Item -Path WSMan:\Localhost\listener -Transport http -Address * -Port \<port-number\>`

<span data-ttu-id="4c5d9-485">Använd inte **port** parametern om du inte behöver det.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-485">Don't use the **Port** parameter unless you must.</span></span> <span data-ttu-id="4c5d9-486">Porten som anges i kommandot gäller för alla datorer eller sessioner där kommandot körs.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-486">The port that is set in the command applies to all computers or sessions on which the command runs.</span></span> <span data-ttu-id="4c5d9-487">En alternativ port inställning kan hindra kommandot från att köras på alla datorer.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-487">An alternate port setting might prevent the command from running on all computers.</span></span>
...
### <span data-ttu-id="4c5d9-488">-RemoteDebug</span><span class="sxs-lookup"><span data-stu-id="4c5d9-488">-RemoteDebug</span></span>

<span data-ttu-id="4c5d9-489">Används för att köra det anropade kommandot i fel söknings läge i den fjärranslutna PowerShell-sessionen.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-489">Used to run the invoked command in debug mode in the remote PowerShell session.</span></span>
...
### <span data-ttu-id="4c5d9-490">-RunAsAdministrator</span><span class="sxs-lookup"><span data-stu-id="4c5d9-490">-RunAsAdministrator</span></span>

<span data-ttu-id="4c5d9-491">Anger att denna cmdlet anropar ett kommando som administratör.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-491">Indicates that this cmdlet invokes a command as an Administrator.</span></span>
...
### <span data-ttu-id="4c5d9-492">– Script block</span><span class="sxs-lookup"><span data-stu-id="4c5d9-492">-ScriptBlock</span></span>

<span data-ttu-id="4c5d9-493">Anger vilka kommandon som ska köras.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-493">Specifies the commands to run.</span></span> <span data-ttu-id="4c5d9-494">Sätt i kommandona inom klammerparenteser `{ }` för att skapa ett skript block.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-494">Enclose the commands in curly braces `{ }` to create a script block.</span></span>
<span data-ttu-id="4c5d9-495">Den här parametern är obligatorisk.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-495">This parameter is required.</span></span>

<span data-ttu-id="4c5d9-496">Som standard utvärderas alla variabler i kommandot på fjärrdatorn.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-496">By default, any variables in the command are evaluated on the remote computer.</span></span> <span data-ttu-id="4c5d9-497">Använd **argument List** om du vill inkludera lokala variabler i kommandot.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-497">To include local variables in the command, use **ArgumentList**.</span></span>
...
### <span data-ttu-id="4c5d9-498">– Session</span><span class="sxs-lookup"><span data-stu-id="4c5d9-498">-Session</span></span>

<span data-ttu-id="4c5d9-499">Anger en matris med sessioner där denna cmdlet kör kommandot.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-499">Specifies an array of sessions in which this cmdlet runs the command.</span></span> <span data-ttu-id="4c5d9-500">Ange en variabel som innehåller **PSSession** -objekt eller ett kommando som skapar eller hämtar **PSSession** -objekt, till exempel ett `New-PSSession` eller- `Get-PSSession` kommando.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-500">Enter a variable that contains **PSSession** objects or a command that creates or gets the **PSSession** objects, such as a `New-PSSession` or `Get-PSSession` command.</span></span>

<span data-ttu-id="4c5d9-501">När du skapar en **PSSession** upprättar PowerShell en permanent anslutning till fjärrdatorn.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-501">When you create a **PSSession** , PowerShell establishes a persistent connection to the remote computer.</span></span> <span data-ttu-id="4c5d9-502">Använd en **PSSession** för att köra en serie relaterade kommandon som delar data.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-502">Use a **PSSession** to run a series of related commands that share data.</span></span> <span data-ttu-id="4c5d9-503">Om du vill köra ett enda kommando eller en serie med orelaterade kommandon använder du parametern **computername** .</span><span class="sxs-lookup"><span data-stu-id="4c5d9-503">To run a single command or a series of unrelated commands, use the **ComputerName** parameter.</span></span> <span data-ttu-id="4c5d9-504">Mer information finns i [about_PSSessions](./About/about_PSSessions.md).</span><span class="sxs-lookup"><span data-stu-id="4c5d9-504">For more information, see [about_PSSessions](./About/about_PSSessions.md).</span></span>
...
### <span data-ttu-id="4c5d9-505">-Sessionsnamn</span><span class="sxs-lookup"><span data-stu-id="4c5d9-505">-SessionName</span></span>

<span data-ttu-id="4c5d9-506">Anger ett eget namn för en frånkopplad session.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-506">Specifies a friendly name for a disconnected session.</span></span> <span data-ttu-id="4c5d9-507">Du kan använda namnet för att referera till sessionen i efterföljande kommandon, till exempel ett `Get-PSSession` kommando.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-507">You can use the name to refer to the session in subsequent commands, such as a `Get-PSSession` command.</span></span> <span data-ttu-id="4c5d9-508">Den här parametern är endast giltig med parametern **InDisconnectedSession** .</span><span class="sxs-lookup"><span data-stu-id="4c5d9-508">This parameter is valid only with the **InDisconnectedSession** parameter.</span></span>

<span data-ttu-id="4c5d9-509">Den här parametern introducerades i PowerShell 3,0.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-509">This parameter was introduced in PowerShell 3.0.</span></span>
...
### <span data-ttu-id="4c5d9-510">-SessionOption</span><span class="sxs-lookup"><span data-stu-id="4c5d9-510">-SessionOption</span></span>

<span data-ttu-id="4c5d9-511">Anger avancerade alternativ för sessionen.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-511">Specifies advanced options for the session.</span></span> <span data-ttu-id="4c5d9-512">Ange ett **SessionOption** -objekt, t. ex. ett som du skapar med hjälp av `New-PSSessionOption` cmdleten, eller en hash-tabell där nycklarna är namn på sessionstillstånd och värdena är alternativ värden för session.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-512">Enter a **SessionOption** object, such as one that you create using the `New-PSSessionOption` cmdlet, or a hash table in which the keys are session option names and the values are session option values.</span></span>

<span data-ttu-id="4c5d9-513">Standardvärdena för alternativen bestäms av värdet för `$PSSessionOption` variabeln Preference, om det har angetts.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-513">The default values for the options are determined by the value of the `$PSSessionOption` preference variable, if it's set.</span></span> <span data-ttu-id="4c5d9-514">Annars upprättas standardvärdena med alternativ som anges i konfigurationen av sessionen.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-514">Otherwise, the default values are established by options set in the session configuration.</span></span>

<span data-ttu-id="4c5d9-515">Värdena för sessionens alternativ prioriteras framför standardvärden för sessioner som angetts i `$PSSessionOption` variabeln Preference och i konfigurationen för sessionen.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-515">The session option values take precedence over default values for sessions set in the `$PSSessionOption` preference variable and in the session configuration.</span></span> <span data-ttu-id="4c5d9-516">De har dock inte företräde framför maximala värden, kvoter eller gränser som angetts i konfigurationen av sessionen.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-516">However, they don't take precedence over maximum values, quotas, or limits set in the session configuration.</span></span>

<span data-ttu-id="4c5d9-517">En beskrivning av de sessionsinformation som innehåller standardvärdena finns i `New-PSSessionOption` .</span><span class="sxs-lookup"><span data-stu-id="4c5d9-517">For a description of the session options that includes the default values, see `New-PSSessionOption`.</span></span> <span data-ttu-id="4c5d9-518">Information om `$PSSessionOption` variabeln Preference finns [about_Preference_Variables](About/about_Preference_Variables.md).</span><span class="sxs-lookup"><span data-stu-id="4c5d9-518">For information about the `$PSSessionOption` preference variable, see [about_Preference_Variables](About/about_Preference_Variables.md).</span></span>
<span data-ttu-id="4c5d9-519">För ytterligare information om sessionskonfigurationer, se [about_Session_Configurations](About/about_Session_Configurations.md).</span><span class="sxs-lookup"><span data-stu-id="4c5d9-519">For more information about session configurations, see [about_Session_Configurations](About/about_Session_Configurations.md).</span></span>
...
### <span data-ttu-id="4c5d9-520">-SSHConnection</span><span class="sxs-lookup"><span data-stu-id="4c5d9-520">-SSHConnection</span></span>

<span data-ttu-id="4c5d9-521">Den här parametern tar en matris med hash-tabeller där varje hash-tabell innehåller en eller flera anslutnings parametrar som krävs för att upprätta en SSH-anslutning (Secure Shell).</span><span class="sxs-lookup"><span data-stu-id="4c5d9-521">This parameter takes an array of hash tables where each hash table contains one or more connection parameters needed to establish a Secure Shell (SSH) connection.</span></span> <span data-ttu-id="4c5d9-522">Parametern **SSHConnection** är användbar för att skapa flera sessioner där varje session kräver annan anslutnings information.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-522">The **SSHConnection** parameter is useful for creating multiple sessions where each session requires different connection information.</span></span>

<span data-ttu-id="4c5d9-523">Hash-tabellen har följande medlemmar:</span><span class="sxs-lookup"><span data-stu-id="4c5d9-523">The hashtable has the following members:</span></span>

- <span data-ttu-id="4c5d9-524">**Computername** (eller **värdnamn** )</span><span class="sxs-lookup"><span data-stu-id="4c5d9-524">**ComputerName** (or **HostName** )</span></span>
- <span data-ttu-id="4c5d9-525">**Port**</span><span class="sxs-lookup"><span data-stu-id="4c5d9-525">**Port**</span></span>
- <span data-ttu-id="4c5d9-526">**Användar**</span><span class="sxs-lookup"><span data-stu-id="4c5d9-526">**UserName**</span></span>
- <span data-ttu-id="4c5d9-527">**Sökväg till fil Sök väg** (eller **IdentityFilePath** )</span><span class="sxs-lookup"><span data-stu-id="4c5d9-527">**KeyFilePath** (or **IdentityFilePath** )</span></span>

<span data-ttu-id="4c5d9-528">**Computername** (eller **hostname** ) är det enda nyckel/värde-par som krävs.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-528">**ComputerName** (or **HostName** ) is the only key-value pair that is required.</span></span>

<span data-ttu-id="4c5d9-529">Den här parametern introducerades i PowerShell 6,0.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-529">This parameter was introduced in PowerShell 6.0.</span></span>
...
### <span data-ttu-id="4c5d9-530">-SSHTransport</span><span class="sxs-lookup"><span data-stu-id="4c5d9-530">-SSHTransport</span></span>

<span data-ttu-id="4c5d9-531">Anger att fjärr anslutningen upprättas med hjälp av SSH (Secure Shell).</span><span class="sxs-lookup"><span data-stu-id="4c5d9-531">Indicates that the remote connection is established using Secure Shell (SSH).</span></span>

<span data-ttu-id="4c5d9-532">Som standard använder PowerShell Windows WinRM för att ansluta till en fjärrdator.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-532">By default PowerShell uses Windows WinRM to connect to a remote computer.</span></span> <span data-ttu-id="4c5d9-533">Den här växeln tvingar PowerShell att använda **hostname** -parametern för att upprätta en SSH-baserad fjärr anslutning.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-533">This switch forces PowerShell to use the **HostName** parameter for establishing an SSH based remote connection.</span></span>

<span data-ttu-id="4c5d9-534">Den här parametern introducerades i PowerShell 6,0.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-534">This parameter was introduced in PowerShell 6.0.</span></span>
...
### <span data-ttu-id="4c5d9-535">-ThrottleLimit</span><span class="sxs-lookup"><span data-stu-id="4c5d9-535">-ThrottleLimit</span></span>

<span data-ttu-id="4c5d9-536">Anger det maximala antalet samtidiga anslutningar som kan upprättas för att köra det här kommandot.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-536">Specifies the maximum number of concurrent connections that can be established to run this command.</span></span>
<span data-ttu-id="4c5d9-537">Om du utelämnar den här parametern eller anger värdet 0, används standardvärdet 32.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-537">If you omit this parameter or enter a value of 0, the default value, 32, is used.</span></span>

<span data-ttu-id="4c5d9-538">Begränsnings gränsen gäller endast för det aktuella kommandot, inte för sessionen eller datorn.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-538">The throttle limit applies only to the current command, not to the session or to the computer.</span></span>
...
### <span data-ttu-id="4c5d9-539">-UserName</span><span class="sxs-lookup"><span data-stu-id="4c5d9-539">-UserName</span></span>

<span data-ttu-id="4c5d9-540">Anger användar namnet för det konto som används för att köra ett kommando på fjärrdatorn.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-540">Specifies the username for the account used to run a command on the remote computer.</span></span> <span data-ttu-id="4c5d9-541">Metoden för användarautentisering är beroende av hur Secure Shell (SSH) är konfigurerat på fjärrdatorn.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-541">The user authentication method depends on how Secure Shell (SSH) is configured on the remote computer.</span></span>

<span data-ttu-id="4c5d9-542">Om SSH har kon figurer ATS för grundläggande lösenordsautentisering uppmanas du att ange användar lösen ordet.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-542">If SSH is configured for basic password authentication, then you'll be prompted for the user password.</span></span>

<span data-ttu-id="4c5d9-543">Om SSH har kon figurer ATS för nyckelbaserad användarautentisering kan en nyckel fil Sök väg tillhandahållas via parametern för nyckel **Sök väg** och inget lösen ord visas.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-543">If SSH is configured for key-based user authentication then a key file path can be provided via the **KeyFilePath** parameter and no password prompt occurs.</span></span> <span data-ttu-id="4c5d9-544">Om klientens användar nyckel finns på en känd SSH-plats behövs inte parametern för nyckel **Sök** vägar för nyckelbaserad autentisering, och användarautentisering sker automatiskt baserat på användar namnet.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-544">If the client user key file is located in an SSH known location, then the **KeyFilePath** parameter isn't needed for key-based authentication, and user authentication occurs automatically based on the username.</span></span> <span data-ttu-id="4c5d9-545">Mer information finns i din plattforms SSH-dokumentation om nyckelbaserad användarautentisering.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-545">For more information, see your platform's SSH documentation about key-based user authentication.</span></span>

<span data-ttu-id="4c5d9-546">Detta är inte en obligatorisk parameter.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-546">This isn't a required parameter.</span></span> <span data-ttu-id="4c5d9-547">Om parametern **username** inte anges används det aktuella inloggade användar namnet för anslutningen.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-547">If the **UserName** parameter isn't specified, then the current logged on username is used for the connection.</span></span>

<span data-ttu-id="4c5d9-548">Den här parametern introducerades i PowerShell 6,0.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-548">This parameter was introduced in PowerShell 6.0.</span></span>
...
### <span data-ttu-id="4c5d9-549">-UseSSL</span><span class="sxs-lookup"><span data-stu-id="4c5d9-549">-UseSSL</span></span>

<span data-ttu-id="4c5d9-550">Anger att denna cmdlet använder Secure Sockets Layer-protokollet (SSL) för att upprätta en anslutning till fjärrdatorn.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-550">Indicates that this cmdlet uses the Secure Sockets Layer (SSL) protocol to establish a connection to the remote computer.</span></span> <span data-ttu-id="4c5d9-551">Som standard används inte SSL.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-551">By default, SSL isn't used.</span></span>

<span data-ttu-id="4c5d9-552">WS-Management krypterar allt PowerShell-innehåll som överförs via nätverket.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-552">WS-Management encrypts all PowerShell content transmitted over the network.</span></span> <span data-ttu-id="4c5d9-553">Parametern **UseSSL** är ett ytterligare skydd som skickar data via https i stället för http.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-553">The **UseSSL** parameter is an additional protection that sends the data across an HTTPS, instead of HTTP.</span></span>

<span data-ttu-id="4c5d9-554">Om du använder den här parametern, men SSL inte är tillgängligt på den port som används för kommandot, Miss lyckas kommandot.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-554">If you use this parameter, but SSL isn't available on the port that's used for the command, the command fails.</span></span>
...
### <span data-ttu-id="4c5d9-555">-VMId</span><span class="sxs-lookup"><span data-stu-id="4c5d9-555">-VMId</span></span>

<span data-ttu-id="4c5d9-556">Anger en matris med ID: n för virtuella datorer.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-556">Specifies an array of IDs of virtual machines.</span></span>
...
### <span data-ttu-id="4c5d9-557">– VMName</span><span class="sxs-lookup"><span data-stu-id="4c5d9-557">-VMName</span></span>

<span data-ttu-id="4c5d9-558">Anger en matris med namn på virtuella datorer.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-558">Specifies an array of names of virtual machines.</span></span>
...
### <span data-ttu-id="4c5d9-559">-Under system</span><span class="sxs-lookup"><span data-stu-id="4c5d9-559">-Subsystem</span></span>

<span data-ttu-id="4c5d9-560">Anger det SSH-undersystem som används för den nya **PSSession**.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-560">Specifies the SSH subsystem used for the new **PSSession**.</span></span>

<span data-ttu-id="4c5d9-561">Detta anger under systemet som ska användas på målet som det definieras i sshd_config.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-561">This specifies the subsystem to use on the target as defined in sshd_config.</span></span>
<span data-ttu-id="4c5d9-562">Under systemet startar en angiven version av PowerShell med fördefinierade parametrar.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-562">The subsystem starts a specific version of PowerShell with predefined parameters.</span></span>
<span data-ttu-id="4c5d9-563">Om det angivna under systemet inte finns på fjärrdatorn Miss lyckas kommandot.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-563">If the specified subsystem does not exist on the remote computer, the command fails.</span></span>

<span data-ttu-id="4c5d9-564">Om den här parametern inte används är standard under systemet "PowerShell".</span><span class="sxs-lookup"><span data-stu-id="4c5d9-564">If this parameter is not used, the default is the 'powershell' subsystem.</span></span>
...
### <span data-ttu-id="4c5d9-565">CommonParameters</span><span class="sxs-lookup"><span data-stu-id="4c5d9-565">CommonParameters</span></span>

<span data-ttu-id="4c5d9-566">Denna cmdlet har stöd för parametrarna -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction och -WarningVariable.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-566">This cmdlet supports the common parameters: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction, and -WarningVariable.</span></span> <span data-ttu-id="4c5d9-567">Mer information finns i [about_CommonParameters](https://go.microsoft.com/fwlink/?LinkID=113216).</span><span class="sxs-lookup"><span data-stu-id="4c5d9-567">For more information, see [about_CommonParameters](https://go.microsoft.com/fwlink/?LinkID=113216).</span></span>

## <span data-ttu-id="4c5d9-568">INDATA</span><span class="sxs-lookup"><span data-stu-id="4c5d9-568">INPUTS</span></span>

### <span data-ttu-id="4c5d9-569">System. Management. Automation. script block</span><span class="sxs-lookup"><span data-stu-id="4c5d9-569">System.Management.Automation.ScriptBlock</span></span>

<span data-ttu-id="4c5d9-570">Du kan skicka vidare ett kommando i ett skript block till `Invoke-Command` .</span><span class="sxs-lookup"><span data-stu-id="4c5d9-570">You can pipe a command in a script block to `Invoke-Command`.</span></span> <span data-ttu-id="4c5d9-571">Använd den `$Input` automatiska variabeln för att representera inobjekten i kommandot.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-571">Use the `$Input` automatic variable to represent the input objects in the command.</span></span>

## <span data-ttu-id="4c5d9-572">UTDATA</span><span class="sxs-lookup"><span data-stu-id="4c5d9-572">OUTPUTS</span></span>

### <span data-ttu-id="4c5d9-573">System. Management. Automation. PSRemotingJob, system. Management. Automation. körnings utrymmen. PSSession eller utdata från det anropade kommandot</span><span class="sxs-lookup"><span data-stu-id="4c5d9-573">System.Management.Automation.PSRemotingJob, System.Management.Automation.Runspaces.PSSession, or the output of the invoked command</span></span>

<span data-ttu-id="4c5d9-574">Den här cmdleten returnerar ett jobb objekt, om du använder parametern **AsJob** .</span><span class="sxs-lookup"><span data-stu-id="4c5d9-574">This cmdlet returns a job object, if you use the **AsJob** parameter.</span></span> <span data-ttu-id="4c5d9-575">Om du anger parametern **InDisconnectedSession** `Invoke-Command` returnerar ett **PSSession** -objekt.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-575">If you specify the **InDisconnectedSession** parameter, `Invoke-Command` returns a **PSSession** object.</span></span> <span data-ttu-id="4c5d9-576">Annars returnerar den utdata från kommandot som anropades, vilket är värdet för parametern **script block** .</span><span class="sxs-lookup"><span data-stu-id="4c5d9-576">Otherwise, it returns the output of the invoked command, which is the value of the **ScriptBlock** parameter.</span></span>

## <span data-ttu-id="4c5d9-577">ANTECKNINGAR</span><span class="sxs-lookup"><span data-stu-id="4c5d9-577">NOTES</span></span>

<span data-ttu-id="4c5d9-578">I Windows Vista och senare versioner av operativ systemet Windows, för att använda parametern **computername** för `Invoke-Command` för att köra ett kommando på den lokala datorn, måste du köra PowerShell med alternativet **Kör som administratör** .</span><span class="sxs-lookup"><span data-stu-id="4c5d9-578">On Windows Vista, and later versions of the Windows operating system, to use the **ComputerName** parameter of `Invoke-Command` to run a command on the local computer, you must run PowerShell using the **Run as administrator** option.</span></span>

<span data-ttu-id="4c5d9-579">När du kör kommandon på flera datorer ansluter PowerShell till datorerna i den ordning som de visas i listan.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-579">When you run commands on multiple computers, PowerShell connects to the computers in the order in which they appear in the list.</span></span> <span data-ttu-id="4c5d9-580">Men kommandots utdata visas i den ordning som den tas emot från fjärrdatorer, vilket kan vara olika.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-580">However, the command output is displayed in the order that it's received from the remote computers, which might be different.</span></span>

<span data-ttu-id="4c5d9-581">Fel som orsakas av kommandot som `Invoke-Command` körs ingår i kommando resultatet.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-581">Errors that result from the command that `Invoke-Command` runs are included in the command results.</span></span>
<span data-ttu-id="4c5d9-582">Fel som avslutar fel i ett lokalt kommando behandlas som icke-avslutande fel i ett fjärrkommando.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-582">Errors that would be terminating errors in a local command are treated as non-terminating errors in a remote command.</span></span> <span data-ttu-id="4c5d9-583">Den här strategin ser till att avslutande fel på en dator inte stänger kommandot på alla datorer där den körs.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-583">This strategy makes sure that terminating errors on one computer don't close the command on all computers on which it's run.</span></span> <span data-ttu-id="4c5d9-584">Den här metoden används även när ett fjärrkommando körs på en enda dator.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-584">This practice is used even when a remote command is run on a single computer.</span></span>

<span data-ttu-id="4c5d9-585">Om fjärrdatorn inte finns i en domän som den lokala datorn litar på, kanske datorn inte kan autentisera användarens autentiseringsuppgifter.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-585">If the remote computer isn't in a domain that the local computer trusts, the computer might not be able to authenticate the user's credentials.</span></span> <span data-ttu-id="4c5d9-586">Om du vill lägga till fjärrdatorn i listan över betrodda värdar i WS-Management använder du följande kommando i `WSMAN` providern, där `<Remote-Computer-Name>` är namnet på fjärrdatorn:</span><span class="sxs-lookup"><span data-stu-id="4c5d9-586">To add the remote computer to the list of trusted hosts in WS-Management, use the following command in the `WSMAN` provider, where `<Remote-Computer-Name>` is the name of the remote computer:</span></span>

`Set-Item -Path WSMan:\Localhost\Client\TrustedHosts -Value \<Remote-Computer-Name\>`

<span data-ttu-id="4c5d9-587">När du kopplar från en **PSSession** med hjälp av **InDisconnectedSession** -parametern är sessionstillståndet **frånkopplat** och tillgängligheten är **ingen**.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-587">When you disconnect a **PSSession** using the **InDisconnectedSession** parameter, the session state is **Disconnected** and the availability is **None**.</span></span> <span data-ttu-id="4c5d9-588">Värdet för egenskapen **State** är i förhållande till den aktuella sessionen.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-588">The value of the **State** property is relative to the current session.</span></span> <span data-ttu-id="4c5d9-589">Värdet **frånkopplat** innebär att **PSSession** inte är ansluten till den aktuella sessionen.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-589">A value of **Disconnected** means that the **PSSession** isn't connected to the current session.</span></span> <span data-ttu-id="4c5d9-590">Det innebär dock inte att **PSSession** är frånkopplad från alla sessioner.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-590">However, it doesn't mean that the **PSSession** is disconnected from all sessions.</span></span> <span data-ttu-id="4c5d9-591">Den kan vara ansluten till en annan session.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-591">It might be connected to a different session.</span></span> <span data-ttu-id="4c5d9-592">Använd egenskapen **tillgänglighet** för att avgöra om du kan ansluta eller återansluta till sessionen.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-592">To determine whether you can connect or reconnect to the session, use the **Availability** property.</span></span>

<span data-ttu-id="4c5d9-593">**Tillgänglighet** svärdet **none** anger att du kan ansluta till sessionen.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-593">An **Availability** value of **None** indicates that you can connect to the session.</span></span> <span data-ttu-id="4c5d9-594">Värdet **upptagen** anger att du inte kan ansluta till **PSSession** eftersom det är anslutet till en annan session.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-594">A value of **Busy** indicates that you can't connect to the **PSSession** because it's connected to another session.</span></span> <span data-ttu-id="4c5d9-595">Mer information om värdena för egenskapen **State** för sessioner finns i [RunspaceState](/dotnet/api/system.management.automation.runspaces.runspacestate).</span><span class="sxs-lookup"><span data-stu-id="4c5d9-595">For more information about the values of the **State** property of sessions, see [RunspaceState](/dotnet/api/system.management.automation.runspaces.runspacestate).</span></span> <span data-ttu-id="4c5d9-596">Mer information om värdena för egenskapen **Availability** för sessioner finns i [RunspaceAvailability](/dotnet/api/system.management.automation.runspaces.runspaceavailability).</span><span class="sxs-lookup"><span data-stu-id="4c5d9-596">For more information about the values of the **Availability** property of sessions, see [RunspaceAvailability](/dotnet/api/system.management.automation.runspaces.runspaceavailability).</span></span>

<span data-ttu-id="4c5d9-597">**Värd** namnen och **SSHConnection** -parametrarna ingick från och med PowerShell 6,0.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-597">The **HostName** and **SSHConnection** parameters were included starting with PowerShell 6.0.</span></span> <span data-ttu-id="4c5d9-598">De lades till för att tillhandahålla PowerShell-fjärrkommunikation utifrån SSH (Secure Shell).</span><span class="sxs-lookup"><span data-stu-id="4c5d9-598">They were added to provide PowerShell remoting based on Secure Shell (SSH).</span></span> <span data-ttu-id="4c5d9-599">PowerShell och SSH stöds på flera plattformar (Windows, Linux, macOS) och PowerShell-fjärrkommunikation fungerar över dessa plattformar där PowerShell och SSH har installerats och kon figurer ATS.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-599">PowerShell and SSH are supported on multiple platforms (Windows, Linux, macOS) and PowerShell remoting works over these platforms where PowerShell and SSH are installed and configured.</span></span> <span data-ttu-id="4c5d9-600">Detta skiljer sig från den tidigare Windows-fjärrkommunikationen som baseras på WinRM och många av de särskilda WinRM-funktionerna och begränsningarna gäller inte.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-600">This is separate from the previous Windows only remoting that is based on WinRM and many of the WinRM specific features and limitations don't apply.</span></span> <span data-ttu-id="4c5d9-601">Till exempel kan WinRM-baserade kvoter, sessions alternativ, anpassad slut punkts konfiguration och funktionerna för att koppla från/återansluta inte användas för närvarande.</span><span class="sxs-lookup"><span data-stu-id="4c5d9-601">For example WinRM based quotas, session options, custom endpoint configuration, and disconnect/reconnect features are currently not supported.</span></span> <span data-ttu-id="4c5d9-602">Mer information om hur du konfigurerar PowerShell SSH-fjärrkommunikation finns i [PowerShell-fjärrkommunikation via SSH](/powershell/scripting/learn/remoting/ssh-remoting-in-powershell-core).</span><span class="sxs-lookup"><span data-stu-id="4c5d9-602">For more information about how to set up PowerShell SSH remoting, see [PowerShell Remoting Over SSH](/powershell/scripting/learn/remoting/ssh-remoting-in-powershell-core).</span></span>

## <span data-ttu-id="4c5d9-603">RELATERADE LÄNKAR</span><span class="sxs-lookup"><span data-stu-id="4c5d9-603">RELATED LINKS</span></span>

[<span data-ttu-id="4c5d9-604">about_PSSessions</span><span class="sxs-lookup"><span data-stu-id="4c5d9-604">about_PSSessions</span></span>](./About/about_PSSessions.md)

[<span data-ttu-id="4c5d9-605">about_Remote</span><span class="sxs-lookup"><span data-stu-id="4c5d9-605">about_Remote</span></span>](./About/about_Remote.md)

[<span data-ttu-id="4c5d9-606">about_Remote_Disconnected_Sessions</span><span class="sxs-lookup"><span data-stu-id="4c5d9-606">about_Remote_Disconnected_Sessions</span></span>](./About/about_Remote_Disconnected_Sessions.md)

[<span data-ttu-id="4c5d9-607">about_Remote_Troubleshooting</span><span class="sxs-lookup"><span data-stu-id="4c5d9-607">about_Remote_Troubleshooting</span></span>](./About/about_remote_troubleshooting.md)

[<span data-ttu-id="4c5d9-608">about_Remote_Variables</span><span class="sxs-lookup"><span data-stu-id="4c5d9-608">about_Remote_Variables</span></span>](./About/about_Remote_Variables.md)

[<span data-ttu-id="4c5d9-609">about_Scopes</span><span class="sxs-lookup"><span data-stu-id="4c5d9-609">about_Scopes</span></span>](./About/about_scopes.md)

[<span data-ttu-id="4c5d9-610">Retur-PSSession</span><span class="sxs-lookup"><span data-stu-id="4c5d9-610">Enter-PSSession</span></span>](Enter-PSSession.md)

[<span data-ttu-id="4c5d9-611">Avsluta-PSSession</span><span class="sxs-lookup"><span data-stu-id="4c5d9-611">Exit-PSSession</span></span>](Exit-PSSession.md)

[<span data-ttu-id="4c5d9-612">Get-PSSession</span><span class="sxs-lookup"><span data-stu-id="4c5d9-612">Get-PSSession</span></span>](Get-PSSession.md)

[<span data-ttu-id="4c5d9-613">Anropa-objekt</span><span class="sxs-lookup"><span data-stu-id="4c5d9-613">Invoke-Item</span></span>](../Microsoft.PowerShell.Management/Invoke-Item.md)

[<span data-ttu-id="4c5d9-614">New-PSSession</span><span class="sxs-lookup"><span data-stu-id="4c5d9-614">New-PSSession</span></span>](New-PSSession.md)

[<span data-ttu-id="4c5d9-615">Remove-PSSession</span><span class="sxs-lookup"><span data-stu-id="4c5d9-615">Remove-PSSession</span></span>](Remove-PSSession.md)

[<span data-ttu-id="4c5d9-616">WSMan-Provider</span><span class="sxs-lookup"><span data-stu-id="4c5d9-616">WSMan Provider</span></span>](../Microsoft.WsMan.Management/About/about_WSMan_Provider.md)
