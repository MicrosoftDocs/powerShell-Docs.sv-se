...
Strängen `This is a test` skickas ned pipelinen. `Export-Clixml` använder parametern **Path** för att skapa en XML-fil med namnet `sample.xml` i den aktuella katalogen.
