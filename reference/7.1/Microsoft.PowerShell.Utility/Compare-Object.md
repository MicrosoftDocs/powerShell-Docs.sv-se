...
I det här exemplet används parametern **ExcludeDifferent** för att jämföra varje innehålls rad i två textfiler.

Från och med PowerShell 7,1, när du använder parametern **ExcludeDifferent** , härleds **IncludeEqual** och utdata bara innehåller rader i båda filerna, som visas i **SideIndicator** ( `==` ).
