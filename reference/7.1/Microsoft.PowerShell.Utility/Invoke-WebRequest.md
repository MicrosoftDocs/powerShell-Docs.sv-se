...
Om du utelämnar sökvägen är standardvärdet den aktuella platsen. Namnet behandlas som en literal sökväg.
Namn som innehåller hakparenteser ( `[]` ) måste omges av enkla citat tecken ( `'` ).
