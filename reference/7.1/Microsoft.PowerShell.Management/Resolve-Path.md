...
Anger den sökväg som ska matchas.
Värdet för parametern **LiteralPath** används precis som det skrivs.
...
Anger PowerShell-sökvägen som ska lösas.
Den här parametern är obligatorisk.
Du kan också skicka en Sök vägs sträng till `Resolve-Path` .
