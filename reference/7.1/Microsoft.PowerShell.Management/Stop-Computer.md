...
I PowerShell 7,1 `Stop-Computer` lades till för Linux och MacOS. Parametrarna har ingen påverkan på dessa plattformar. Cmdleten anropar bara det ursprungliga kommandot `/sbin/shutdown` .
...
I PowerShell 7,1 `Stop-Computer` lades till för Linux och MacOS. För dessa platorms anropar cmdleten det inbyggda kommandot `/sbin/shutdown` .
