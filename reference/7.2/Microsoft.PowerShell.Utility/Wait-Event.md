...
`Wait-Event`Cmdleten pausar körningen av ett skript eller en funktion tills en viss händelse har Aktiver ATS. Körningen återupptas när händelsen identifieras. Tryck på <kbd>CTRL</kbd>C om du vill avbryta väntan + <kbd></kbd>.
