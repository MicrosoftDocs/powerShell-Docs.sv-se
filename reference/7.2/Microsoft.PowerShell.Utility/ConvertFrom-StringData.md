...
PowerShell 7 lägger till **avgränsnings** parametern.
...
### Exempel 2: konvertera sträng data med hjälp av en annan avgränsare

Det här exemplet visar hur du konverterar sträng data som använder ett annat tecken som avgränsare. I det här exemplet använder sträng data pipe-tecknet ( `|` ) som avgränsare.
...
### Exempel 5: använda ConvertFrom-StringData i DATA avsnittet i ett skript
...
### Exempel 6: Använd pipeline-operatorn för att skicka en sträng
...
### Exempel 7: Använd escape-tecken för att lägga till nya rader och retur tecken
...
### Exempel 8: Använd omvänt snedstreck escape-tecken för att rendera en fil Sök väg korrekt
...
Det tecken som används för att avgränsa **nyckeln** från **värde** data i strängen som konverteras.
Standard avgränsaren är likhets tecknet ( `=` ). Den här parametern lades till i PowerShell 7.
