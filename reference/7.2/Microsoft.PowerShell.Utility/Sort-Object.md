...
I det här exemplet sorteras filer och under kataloger i en katalog.
...
I PowerShell 6 `Sort-Object` är parametern **längst ned** ett alternativ till `Select-Object` . Ett exempel är `Get-Process | Sort-Object -Property WS -Bottom 5`.
...
I det här exemplet används två egenskaper för att sortera objekt, **status** och **DisplayName**. **Status** sorteras i fallande ordning och **DisplayName** sorteras i stigande ordning.
...
När du använder de **översta**, **lägsta** eller **stabila** parametrarna levereras de sorterade objekten i den ordning som de togs emot av `Sort-Object` när sorterings villkoren är lika. I det här exemplet sorterar vi siffrorna ett till 20 efter deras värde ' modulo 3 '. Modulo-värdet sträcker sig från noll till två.
...
Anger antalet objekt som ska hämtas från slutet av en sorterad objekt mat ris. Detta resulterar i en stabil sortering.
...
Anger antalet objekt som ska hämtas från början av en sorterad objekt mat ris. Detta resulterar i en stabil sortering.
...
De sorterade objekten levereras i den ordning som de togs emot när sorterings villkoren är lika.

Den här parametern lades till i PowerShell v-6.2.0.
...
Prestanda för sorterings algoritmen är långsammare vid en stabil sortering.
