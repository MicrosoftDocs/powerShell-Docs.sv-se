...
`Test-Connection`Kommandot anropas med parametern **traceroute** . Resultaten, som är `[Microsoft.PowerShell.Commands.TestConnectionCommand+TraceStatus]` objekt, matas ut till den resulterande utdataströmmen. 
