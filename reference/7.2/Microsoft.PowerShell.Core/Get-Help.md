...
>[!NOTE]
> I PowerShell 3,0 och PowerShell 4,0 `Get-Help` går det inte  att hitta artiklar i moduler om modulen inte har importer ATS till den aktuella sessionen. Detta är ett känt problem. **Om** du vill hämta artiklar i en modul importerar du modulen antingen med hjälp av `Import-Module` cmdleten eller genom att köra en cmdlet som ingår i modulen.
