...
När du anger en enskild **egenskap** till `Where-Object` , behandlas värdet för egenskapen som ett booleskt uttryck. Om värdet för **längd** inte är noll utvärderas uttrycket till **Sant**. Exempel: `('hi', '', 'there') | Where-Object Length`
...
I exemplet används skript blockets kommando format. Logiska operatorer, till  exempel och **och, är** bara giltiga i skript block. Du kan inte använda dem i jämförelse instruktions formatet för ett `Where-Object` kommando.
...
Exempel: `Get-Process | where ProcessName -CContains "svchost"`
...
Exempel: `Get-Process | where -Value "svchost" -CIn ProcessName`
...
Exempel: `Get-Process | where ProcessName -CLike "*host"`
...
Exempel: `Get-Process | where ProcessName -CMatch "Shell"`
...
Exempel: `Get-Process | where ProcessName -CNotContains "svchost"`
...
Exempel: `Get-Process | where -Value "svchost" -CNotIn -Property ProcessName`
...
Exempel: `Get-Process | where ProcessName -CNotLike "*host"`
...
Exempel: `Get-Process | where ProcessName -CNotMatch "Shell"`
...
Exempel: `Get-Process | where ProcessName -Contains "Svchost"`
...
Exempel: `Get-Process | where ProcessName -Like "*host"`
...
Exempel: `Get-Process | where ProcessName -Match "shell"`
...
Exempel: `Get-Service | where -Not "DependentServices"`
...
Exempel: `Get-Process | where ProcessName -NotContains "Svchost"`
...
Exempel: `Get-Process | where -Value "svchost" -NotIn -Property ProcessName`
...
Exempel: `Get-Process | where ProcessName -NotLike "*host"`
...
Exempel: `Get-Process | where ProcessName -NotMatch "PowerShell"`
