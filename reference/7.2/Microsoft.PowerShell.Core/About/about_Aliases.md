...
Sedan kan du skicka vidare till Get-Member-cmdlet: en. Exempel:
...
Om du vill visa innehållet i enheten från en annan PowerShell-enhet börjar du med sökvägen med enhets namnet. Inkludera kolon (:). Exempel:
