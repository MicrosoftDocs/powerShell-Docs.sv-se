...
Anger att denna cmdlet läser in Windows-användarprofilen som lagras i `HKEY_USERS` register nyckeln för den aktuella användaren.
...
Starta den nya processen i det aktuella konsol fönstret. Som standard öppnas ett nytt fönster i PowerShell.
