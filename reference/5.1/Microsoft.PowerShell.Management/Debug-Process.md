...
Det här kommandot kopplar en fel sökare till Windows PowerShell-processen på datorn.
...
Det här kommandot kopplar en fel sökare till Windows PowerShell-processer på datorn.
Den använder cmdleten **Get-process** för att hämta Windows PowerShell-processer på datorn och använder en pipeline-operator (|) för att skicka processerna till **Debug-process-** cmdlet: en.
...
Det här kommandot kopplar en fel sökare till de aktuella Windows PowerShell-processerna på datorn.

Kommandot använder den automatiska variabeln $PID, som innehåller process-ID: t för den aktuella Windows PowerShell-processen.
...
Kommandot använder cmdleten **Get-process** för att hämta MyApp-processerna på Server01-och Server02-datorerna.
Den använder en pipeline-operator för att skicka processerna till Debug-Process-cmdlet, som kopplar fel sökningarna.
...
Det här kommandot kopplar en fel sökare till Windows PowerShell-processer på den lokala datorn.

Det första kommandot använder cmdleten **Get-process** för att hämta Windows PowerShell-processer på datorn.
