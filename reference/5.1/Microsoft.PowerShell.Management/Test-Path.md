...
När en blank steg sträng anges för `-Path` parametern returneras **True**. Returnerar ett fel när en tom sträng anges `Test-Path` . I följande exempel visas blank steg och en tom sträng.
...
`Test-Path`Är utformad för att fungera med data som exponeras av vilken provider som helst.
