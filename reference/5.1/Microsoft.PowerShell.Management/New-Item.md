...
> [!NOTE]
> När du skapar en fil med den här metoden kodas den resulterande filen som UTF-8 utan en byte-order-markering (BOM).
...
### Exempel 6: Använd parametern-Force för att försöka återskapa mappar
...
### Exempel 7: Använd parametern-Force för att skriva över befintliga filer
