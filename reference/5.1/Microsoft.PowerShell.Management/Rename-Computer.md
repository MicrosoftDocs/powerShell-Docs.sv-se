...
Anger vilket protokoll som ska användas för att byta namn på datorn.
De acceptabla värdena för den här parametern är: WSMan och DCOM.
Standardvärdet är DCOM.
