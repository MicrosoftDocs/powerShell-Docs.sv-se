...
`Set-PackageSource`Ersätter en paket källa för en angiven paket leverantör. Paket källor hanteras alltid av en paket leverantör.
...
Anger att `Set-PackageSource` paket leverantören ska installeras automatiskt av **PackageManagement** .
...
Anger ett paket käll-ID-objekt som representerar det paket som du vill ändra. Paketets käll-ID är en del av resultatet av `Get-PackageSource` cmdleten.
...
Anger den aktuella paket käll platsen. Värdet kan vara en URI, en fil Sök väg eller något annat mål format som stöds av paket leverantören.
...
Anger namnet på en paket källa.
...
Anger den nya platsen för en paket källa. Värdet kan vara en URI, en fil Sök väg eller något annat mål format som stöds av paket leverantören.
...
Anger det nya namnet som du tilldelar till en paket källa.
...
Anger att källan är en betrodd paket leverantör. Betrodda källor efterfrågar inte verifiering för att installera paket.
...
### `Set-PackageSource` accepterar inte inmatade pipelines.
