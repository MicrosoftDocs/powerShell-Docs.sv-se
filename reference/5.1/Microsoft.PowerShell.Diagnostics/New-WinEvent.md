...
Du kan använda denna cmdlet för att lägga till händelser i ETW-kanaler från Windows PowerShell.
...
När den angivna nytto lasten inte matchar nytto lasten i händelse definitionen genererar Windows PowerShell en varning, men kommandot slutförs ändå.
...
Anger händelsens versions nummer. Skriv händelse numret. Windows PowerShell konverterar talet till den typ av byte som krävs.
