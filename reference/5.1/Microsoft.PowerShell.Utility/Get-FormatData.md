...
> [!IMPORTANT]
> För att se till att den fullständiga typen av formatering returneras ska du alltid inkludera parametern **PowerShellVersion** med rätt version. Om parametern och värdet utelämnas kan du inte hämta all korrekt typ information.
