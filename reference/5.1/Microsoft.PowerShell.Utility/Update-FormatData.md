...
När Windows PowerShell startar läses format data in från filerna i installations katalogen för PowerShell ( `$pshome` ) till sessionen. Du kan använda `Update-FormatData` för att läsa in formaterings data i den aktuella sessionen utan att starta om PowerShell. Detta är användbart när du har lagt till eller ändrat en format fil, men inte vill avbryta sessionen.
...
När .NET-objekt formateras, använder Windows PowerShell den första format definition som hittas för varje .NET-typ. Om du använder **AppendPath** -parametern söker Windows PowerShell igenom data från de inbyggda filerna innan de påträffar de formateringsändringar som du lägger till.
...
När .NET-objekt formateras, använder Windows PowerShell den första format definition som hittas för varje .NET-typ. Om du använder **PrependPath** -parametern söker Windows PowerShell igenom data från filerna som du lägger till innan den påträffar formaterings data från de inbyggda filerna.
