...
> [!IMPORTANT]
> Det finns ett problem med den här växeln i Windows PowerShell som åtgärdas i PowerShell 6,2 och senare. När du använder **noenumeration** och uttryckligen använder parametern **InputObject** , räknas kommandot fortfarande upp. Undvik detta genom att skicka **InputObject** -argumenten position (er).
