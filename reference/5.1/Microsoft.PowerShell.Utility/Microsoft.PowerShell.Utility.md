...
Det här avsnittet innehåller hjälp avsnitten för de cmdlet: ar som installeras med Microsoft. PowerShell. Utility-modulen. Den här modulen innehåller cmdletar som hanterar de grundläggande funktionerna i PowerShell.

## Cmdletar för Microsoft. PowerShell. Utility

### [Lägg till medlem](Add-Member.md)
Lägger till anpassade egenskaper och metoder till en instans av ett PowerShell-objekt.

### [Lägg till typ](Add-Type.md)
...
### [Hämta slumpmässiga](Get-Random.md)
...
Importerar värden från en. PSD1-fil utan att anropa innehållet
...
### [Skicka meddelande](Send-MailMessage.md)
...
Anger värdet för en variabel.

### [Visa-kommando](Show-Command.md)
...
### [Start-vilo läge](Start-Sleep.md)
...
### [Avblockera – fil](Unblock-File.md)
...
### [Vänta – fel sökning](Wait-Debugger.md)
...
Skickar de angivna objekten till nästa-kommando i pipelinen.
