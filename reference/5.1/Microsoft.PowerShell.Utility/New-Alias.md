...
## BESKRIVNING
Cmdleten **New-aliase** skapar ett nytt alias i den aktuella Windows PowerShell-sessionen.
Alias som skapats med hjälp av **New-alias** sparas inte när du avslutar-sessionen eller stänger Windows PowerShell.
...
* Om du vill skapa ett nytt alias använder Set-Alias eller New-alias. Om du vill ändra ett alias använder du **set-alias**. Använd Remove-Item om du vill ta bort ett alias.
