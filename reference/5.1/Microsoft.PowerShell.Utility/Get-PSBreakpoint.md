...
**Get-PSBreakpoint** är en av flera cmdletar utformade för fel sökning av Windows PowerShell-skript och-kommandon. Mer information om Windows PowerShell-felsökaren finns about_Debuggers.
