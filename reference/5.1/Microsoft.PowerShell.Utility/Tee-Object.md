...
`Tee-Object` använder Unicode-kodning (UTF-16LE) när den skriver till filer. Om du behöver en annan kodning använder du `Out-File` cmdleten med parametern **encoding** .
