...
**Remove-PSBreakpoint** är en av flera cmdletar utformade för fel sökning av Windows PowerShell-skript.
Mer information om Windows PowerShell-felsökaren finns about_Debuggers.
...
Om du vill spara funktionen lägger du till den i din Windows PowerShell-profil.
