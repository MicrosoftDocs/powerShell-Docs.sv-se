...
### Exempel 4: konvertera Active Directory åtkomst behörighet SDDL till en PSCustomObject
...
Det första kommandot använder Active Directory Service Interfaces (ADSI) för att hämta användarobjektet och spara det i variabeln.

Det andra kommandot använder `ConvertFrom-SddlString` cmdleten för att hämta text representation av SDDL-strängen, som finns i SDDL-egenskapen för objektet som representerar säkerhets beskrivningen.

`-Type`Parametern används för att ange att SDDL-strängen representerar en Active Directory säkerhets beskrivning.
