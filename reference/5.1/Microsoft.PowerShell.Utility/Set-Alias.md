...
Om du vill skapa ett nytt alias använder du `Set-Alias` eller `New-Alias` . Om du vill ta bort ett alias använder du `Remove-Item` cmdleten. Till exempel `Remove-Item -Path Alias:aliasname`.
