...
I det här exemplet används `Get-FileHash` cmdleten för att beräkna hash-värdet för `Powershell.exe` filen.
Den hash-algoritm som används är standard SHA256. Utdata är skickas till `Format-List` cmdleten för att formatera utdata som en lista.
