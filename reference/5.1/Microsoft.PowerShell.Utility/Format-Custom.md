...
`Format-Custom` är utformat för att Visa vyer som inte är bara tabeller eller bara listor. Du kan använda de vyer som definierats i `*format.PS1XML` filerna i PowerShell-katalogen, eller så kan du skapa egna vyer i nya PS1XML-filer och använda `Update-FormatData` cmdleten för att lägga till dem i PowerShell.
