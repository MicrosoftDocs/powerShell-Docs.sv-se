...
`Wait-Job`Cmdleten väntar på att Windows PowerShell-arbetsjobben ska slutföras innan kommando tolken visas. Du kan vänta tills ett bakgrunds jobb har slutförts, eller tills alla bakgrunds jobb är slutförda, och du kan ange en maximal vänte tid för jobbet.
