...
## SAMMANFATTNING
Ignorerar kommando tolken tills en eller flera av de Windows PowerShell-bakgrunds jobb som körs i sessionen har slutförts.
...
## BESKRIVNING
Cmdleten **wait-Job** väntar på att Windows PowerShell-arbetsjobb ska slutföras innan kommando tolken visas.
...
Mer information om hur du **använder** omfångs modifieraren finns i about_Remote_Variables ( https://go.microsoft.com/fwlink/?LinkID=252653) .
