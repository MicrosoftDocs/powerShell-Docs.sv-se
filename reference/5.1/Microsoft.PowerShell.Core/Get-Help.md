...
Parametern **ShowWindow** stöder hjälp avsnitt för kommandon (cmdlets, functions, CIM-kommandon, arbets flöden, skript) och konceptuella **om** artiklar. Den har inte stöd för leverantörs hjälp.
