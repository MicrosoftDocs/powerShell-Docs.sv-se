...
Det här objektet innehåller information om Windows PowerShell-körnings utrymme som den angivna användaren skulle interagera med för den angivna slut punkten.
