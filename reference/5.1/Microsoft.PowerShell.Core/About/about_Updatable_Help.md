...
## <a name="update-help-in-the-powershell-ise"></a>Uppdatera hjälpen i PowerShell ISE

Du kan också uppdatera hjälpen med hjälp av **Update PowerShell-hjälpen** på Hjälp-menyn i PowerShell (Integrated Scripting Environment).

**Hjälp objektet Update PowerShell** kör ett `Update-Help` kommando utan parametrar.
...
> [!NOTE]
> Uppdaterings bara hjälp innehåll publiceras för närvarande bara på engelska (en-US).
