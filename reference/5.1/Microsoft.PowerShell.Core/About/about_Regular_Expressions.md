...
I följande exempel lagras de senaste **SUCCESSAUDIT** från säkerhets loggen i Windows. Det angivna reguljära uttrycket extraherar användar namnet och domänen från meddelandet och lagrar dem under nycklarna: **N** för namn och **D** för domän.
