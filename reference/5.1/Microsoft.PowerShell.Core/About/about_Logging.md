...
---
# <a name="about-logging"></a>Om loggning
...
PowerShell-loggar kan visas med hjälp av Windows Loggboken. Händelse loggen finns i gruppen program-och tjänst loggar och har namnet `Microsoft-Windows-PowerShell` . Den tillhör ande ETW-providern `GUID` är `{A0C1853B-5C40-4B15-8766-3CF1C58F985A}` .

När skript block loggning är aktiverat loggar PowerShell följande händelser i `Microsoft-Windows-PowerShell/Operational` loggen:
