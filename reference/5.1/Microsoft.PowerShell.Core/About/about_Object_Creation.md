...
- [ConvertFrom-sträng](xref:Microsoft.PowerShell.Utility.ConvertFrom-String): byggd ovanpå [FlashExtract](https://www.microsoft.com/research/publication/flashextract-framework-data-extraction-examples), `ConvertFrom-String` skapar anpassade objekt från strukturerade sträng data.
  Det här avsnittet visar och diskuterar var och en av dessa metoder.
