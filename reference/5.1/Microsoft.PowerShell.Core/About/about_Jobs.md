...
I det här avsnittet beskrivs hur du kör bakgrunds jobb i PowerShell på en lokal dator. Information om hur du kör bakgrunds jobb på fjärrdatorer finns [about_Remote_Jobs](about_Remote_Jobs.md). Mer information om tråd jobb finns i [about_Thread_Jobs](/powershell/module/microsoft.powershell.core/about/about_Thread_Jobs).
