...
Om du vill hitta de cmdlet: ar som har en ComputerName-parameter men inte använda Windows PowerShell-fjärrkommunikation läser du beskrivningen av ComputerName-parametern för cmdletarna.
