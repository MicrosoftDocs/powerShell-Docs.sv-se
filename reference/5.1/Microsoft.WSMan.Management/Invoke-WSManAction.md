...
Invoke-WSManAction kör en åtgärd på objektet som anges av RESOURCE_URI, där parametrar anges med nyckel värdes par.
...
Du anger hanterings resursen med parametrarna ResourceURI och SelectorSet.
