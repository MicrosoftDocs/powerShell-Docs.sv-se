...
Cmdlet: en **Invoke-OperationValidation** anropar åtgärds validerings Ramverks test för en angiven modul.

## EXEMPEL

### Exempel 1: anropa ett verifierings test för åtgärden
...
Det här kommandot hämtar modulen med namnet OperationValidation och använder pipelinen för att skicka den till cmdleten **Invoke-OperationValidation** , som kör testet.

## PARAMETRAR

### -IncludePesterOutput

Innehåller pester test-utdata.
...
Anger sökvägen till en test fil för åtgärds validerings ramverk.
...
Anger ett anpassat objekt som anger sökvägen till filen och namnet på testet som ska köras.
...
Du kan skicka vidare utdata från **Get-OperationValidation** till denna cmdlet.

## UTDATA

### PSCustomObject

**PSCustomObject** beskriver huruvida verifieringen lyckades.
