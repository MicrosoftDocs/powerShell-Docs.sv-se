...
Skapar eller ändrar objektets princip för central åtkomst.
Ange CAP-ID: t eller det egna namnet för en central åtkomst princip på datorn.

Från och med Windows Server 2012 kan administratörer använda Active Directory och grupprincip för att ange principer för central åtkomst för användare och grupper.
Mer information finns i [dynamisk Access Control: Scenario översikt](/windows-server/identity/solution-guides/dynamic-access-control--scenario-overview).
