...
> [!IMPORTANT]
> För att se till att den fullständiga typen av formatering returneras ska du alltid inkludera parametern **PowerShellVersion** med värdet när du `5.1` använder ett lokalt anrop av `Get-FormatData` . Om parametern och värdet utelämnas kan du inte hämta all korrekt typ information.
