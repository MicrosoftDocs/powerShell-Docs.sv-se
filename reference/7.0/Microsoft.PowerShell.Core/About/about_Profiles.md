...
|Aktuell användare, alla värdar   |$Home \\ [My] Documents \\ PowerShell \\Profile.ps1 |
|Aktuell användare, aktuell värd|$Home \\ [My] Documents \\ PowerShell\\<br>Microsoft.PowerShell_profile.ps1 |
...
Dessutom kan andra program som är värdar för PowerShell stödja sina egna profiler. Visual Studio Code stöder till exempel följande tjänstspecifika profiler.

|Beskrivning               | Sökväg                                     |
|--------------------------|------------------------------------------|
|Alla användare, aktuell värd   |$PSHOME \\Microsoft.VSCode_profile.ps1|
|Aktuell användare, aktuell värd|$Home \\ [My] Documents \\ PowerShell\\<br>Microsoft.VSCode_profile.ps1|
