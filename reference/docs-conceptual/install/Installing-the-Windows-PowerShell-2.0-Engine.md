...
På Windows 8,1 och Windows 8 är Windows PowerShell 2,0-motorn aktiverat som standard. Men om du vill använda det måste du aktivera alternativet för Microsoft .NET Framework 3,5 som krävs. Det här avsnittet beskriver också hur du aktiverar och inaktiverar motor funktionen i Windows PowerShell 2,0.
