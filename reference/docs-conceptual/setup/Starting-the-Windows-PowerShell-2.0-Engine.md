...
2. Använd för att skapa en session på datorn Server01 som använder sessionskonfigurationen PS2 den **ConfigurationName** parametern för cmdletar som skapar en fjärrsession som den [New-PSSession](https://technet.microsoft.com/library/76f6628c-054c-4eda-ba7a-a6f28daaa26f) cmdlet.
...
Starta ett bakgrundsjobb med Windows PowerShell 2.0 motorn med den **PSVersion** parameter för den [Start-Job](https://technet.microsoft.com/library/2bc04935-0deb-4ec0-b856-d7290cca6442) cmdlet.
