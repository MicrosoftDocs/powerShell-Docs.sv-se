...
Aktivera Windows PowerShell 2.0-motorn och Microsoft .NET Framework 3.5 med Service Pack 1 innan du startar Windows PowerShell 2.0-motorn. Anvisningar finns i [installera Windows PowerShell](Installing-Windows-PowerShell.md).
