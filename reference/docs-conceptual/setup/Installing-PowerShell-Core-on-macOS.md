...
Installera först [Homebrew Cask][cask], så att du kan installera fler paket och installera [Cask-versioner] [cask-version] där du kan installera alternativ version av paket:
