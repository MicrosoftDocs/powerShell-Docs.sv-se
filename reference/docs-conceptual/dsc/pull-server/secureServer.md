...
Läsarna bör ha grundläggande kunskaper om DSC och de termer som används för att beskriva de komponenter som ingår i en DSC-distribution. Mer information finns i avsnittet [Översikt över Desired State Configuration i Windows PowerShell](/powershell/scripting/dsc/overview) .
...
[Konfigurations lägen för push och hämtning](/powershell/scripting/dsc/pullServer/pullserver).
...
CPU: 1,4 GHz 64-bitars processor minne: 512 MB disk utrymme: 32 GB nätverk: Gigabit Ethernet-kort
...
Hämta sedan `xPsDesiredStateConfiguration`-modulen med hjälp av följande kommando.
