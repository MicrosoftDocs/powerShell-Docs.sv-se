...
---
# <a name="authoring-a-dsc-resource-in-c"></a>Redigera en DSC-resurs i C @ no__t-0
...
1. Ändra sammansättnings namnet så att det matchar resurs namnet. I det här fallet ska sammansättningen ha namnet **MSFT_XDemoFile**.
