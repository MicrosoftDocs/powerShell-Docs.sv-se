...
|PackageGroup |Om `$true`är **namnet** förväntas vara namnet på en paket grupp som ska användas med en **PackageManager**. **PackageGroup** är inte giltig vid en **fil Sök väg**. |
