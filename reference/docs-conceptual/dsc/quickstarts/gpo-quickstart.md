...
# <a name="quickstart-convert-group-policy-into-dsc"></a>Start Konvertera grupprincip till DSC
...
- `ConvertFrom-SCM` – konverterar baseline-startplaner för Security Compliance Manager, lagrade som `.xml` filer.
