...
> [!NOTE]
> PowerShell-utvecklings miljöer, till exempel VS Code och ISE, har också kodfragment som gör att du automatiskt kan infoga mallar för kommenterings block.

I följande exempel visas ett skript som innehåller en konfiguration och en kommenterings-baserad hjälp för det.
I det här exemplet visas en konfiguration med parametrar. Mer information om hur du använder parametrar i dina konfigurationer finns i [lägga till parametrar i dina konfigurationer](add-parameters-to-a-configuration.md).
