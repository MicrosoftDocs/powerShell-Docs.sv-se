...
| **Versionshistorik** | Versions historiken visar de uppdateringar som gjorts i en modul i PowerShell-galleriet. Om en version av ett paket är dold med funktionen Ta bort kommer den inte att visas i versions historiken, förutom paketets ägare. | Nej | Nej |
...
| Logg | Prioriterad användning av loggen som en sak |
| Säkerhetskopiering |  |
| IaaS |  |
| Linux |  |
| IIS |  |
