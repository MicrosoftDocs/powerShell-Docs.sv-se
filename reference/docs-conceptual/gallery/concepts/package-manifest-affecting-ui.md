...
| **Viktig information** | För moduler hämtas den här informationen från avsnittet ReleaseNotes under PSData\PrivateData. I skript manifest är det. RELEASENOTES-element. | Ja | Ja |
...
| **Functions** | Detta finns i modulen manifest med hjälp av FunctionsToExport. Observera att det bästa tillvägagångs sättet är att uttryckligen lista objekten i stället för att använda jokertecknet "*", eftersom det förbättrar belastnings-modulens prestanda för användare. | Ja | Nej |
