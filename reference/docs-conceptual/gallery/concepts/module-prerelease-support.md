...
<span data-ttu-id="1f543-125">De detaljerade kraven för för hands versions strängen är:</span><span class="sxs-lookup"><span data-stu-id="1f543-125">The detailed requirements for Prerelease string are:</span></span>
