...
Det här avsnittet innehåller hjälpämnen för den **ISE** modulen som innehåller kommandon som du kan använda i Windows PowerShell Integrated Scripting Environment (ISE). Den **ISE** modulen är installerad med Windows PowerShell.
...
- [Med Windows PowerShell-skript](../../getting-started/fundamental/Scripting-with-Windows-PowerShell.md)
