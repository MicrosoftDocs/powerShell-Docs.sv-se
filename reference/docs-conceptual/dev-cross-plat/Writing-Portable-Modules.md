...
> [!NOTE]
> Även om ett API kan finnas i .NET standard kan API-implementeringen i .NET Core medföra en `PlatformNotSupportedException` vid körning, så för att kontrol lera kompatibilitet med Windows PowerShell och PowerShell Core är det bästa sättet att köra tester för modulen i båda miljöerna.
