...
<span data-ttu-id="42f9d-115">Om du vill se en fullständig lista över funktioner och korrigeringar går du till [ChangeLogs](https://github.com/PowerShell/PowerShell/blob/master/CHANGELOG/7.0.md).</span><span class="sxs-lookup"><span data-stu-id="42f9d-115">To see a full list of features and fixes, see the [changelogs](https://github.com/PowerShell/PowerShell/blob/master/CHANGELOG/7.0.md).</span></span>
...
## <a name="improved-backwards-compatibility-with-windows-powershell"></a><span data-ttu-id="42f9d-145">Förbättrad bakåtkompatibilitet med Windows PowerShell</span><span class="sxs-lookup"><span data-stu-id="42f9d-145">Improved backwards compatibility with Windows PowerShell</span></span>
...
- <span data-ttu-id="42f9d-166">`<if-true>`Uttrycket körs om `<condition>` uttrycket är sant</span><span class="sxs-lookup"><span data-stu-id="42f9d-166">The `<if-true>` expression is executed if the `<condition>` expression is true</span></span>
...
<span data-ttu-id="42f9d-179">Här är det första kommandot som slutförs och det andra kommandot körs:</span><span class="sxs-lookup"><span data-stu-id="42f9d-179">Here, the first command succeeds and the second command is executed:</span></span>
...
<span data-ttu-id="42f9d-194">I följande exempel kommer den högra operanden inte att utvärderas:</span><span class="sxs-lookup"><span data-stu-id="42f9d-194">In the following example, the right-hand operand won't be evaluated:</span></span>
...
<span data-ttu-id="42f9d-225">PowerShell 7 använder uppdaterings meddelanden för att varna användarna om att det finns uppdateringar till PowerShell.</span><span class="sxs-lookup"><span data-stu-id="42f9d-225">PowerShell 7 uses update notifications to alert users to the existence of updates to PowerShell.</span></span>
...
<span data-ttu-id="42f9d-241">Så här anger du versions meddelandet `LTS` endast för versioner:</span><span class="sxs-lookup"><span data-stu-id="42f9d-241">To set the version notification for `LTS` releases only:</span></span>
...
- <span data-ttu-id="42f9d-268">Åtgärda NullReferenceException i CompletionCompleters offentliga metoder (#11274)</span><span class="sxs-lookup"><span data-stu-id="42f9d-268">Fix NullReferenceException in CompletionCompleters public methods (#11274)</span></span>
...
- <span data-ttu-id="42f9d-287">Lägg till inbyggd binär matchare (#11032) (tack @iSazonov !)</span><span class="sxs-lookup"><span data-stu-id="42f9d-287">Add native binary resolver (#11032) (Thanks @iSazonov!)</span></span>
...
- <span data-ttu-id="42f9d-307">Gör ConvertTo-JSON-behandling [AutomationNull]:: värde och [NullString]:: värde som $null (#10957)</span><span class="sxs-lookup"><span data-stu-id="42f9d-307">Make ConvertTo-Json treat [AutomationNull]::Value and [NullString]::Value as $null (#10957)</span></span>
...
- <span data-ttu-id="42f9d-327">Hoppa över fil vid slut för ande av filer om det inte går att läsa filattribut (#10910)</span><span class="sxs-lookup"><span data-stu-id="42f9d-327">During tab completion, skip file if can't read file attributes (#10910)</span></span>
...
- <span data-ttu-id="42f9d-347">Ersätt API-ms-win-core-File-L1-2 -2. dll med Kernell32. dll för FindFirstStreamW och FindNextStreamW-API: er (#10680) (tack @iSazonov !)</span><span class="sxs-lookup"><span data-stu-id="42f9d-347">Replace api-ms-win-core-file-l1-2-2.dll with Kernell32.dll for FindFirstStreamW and FindNextStreamW APIs (#10680) (Thanks @iSazonov!)</span></span>
...
- <span data-ttu-id="42f9d-365">Åtgärda rekursion i OneDrive-Change FindFirstFileEx () för att använda SafeFindHandle-typ (#10405)</span><span class="sxs-lookup"><span data-stu-id="42f9d-365">Fix recursion into OneDrive - change FindFirstFileEx() to use SafeFindHandle type (#10405)</span></span>
...
- <span data-ttu-id="42f9d-383">Åtgärda problem med formatmall (#10998) (tack @iSazonov !)</span><span class="sxs-lookup"><span data-stu-id="42f9d-383">Fix style issues (#10998) (Thanks @iSazonov!)</span></span>
...
- <span data-ttu-id="42f9d-400">Rensa AutomationEngine och ta bort extra SetSessionStateDrive-metod anrop (#10416) (tack @iSazonov !)</span><span class="sxs-lookup"><span data-stu-id="42f9d-400">Cleanup AutomationEngine and remove extra SetSessionStateDrive method call (#10416) (Thanks @iSazonov!)</span></span>
...
- <span data-ttu-id="42f9d-415">Öka tiden mellan nya test-URL: er (#11015)</span><span class="sxs-lookup"><span data-stu-id="42f9d-415">Increase time between retries of testing URL (#11015)</span></span>
- <span data-ttu-id="42f9d-416">Uppdatera testerna för att korrekt beskriva test åtgärder.</span><span class="sxs-lookup"><span data-stu-id="42f9d-416">Update tests to accurately describe test actions.</span></span> <span data-ttu-id="42f9d-417">(#10928) (Tack @romero126 !)</span><span class="sxs-lookup"><span data-stu-id="42f9d-417">(#10928) (Thanks @romero126!)</span></span>
- <span data-ttu-id="42f9d-418">Tillfälligt hoppa över flaky test TestAppDomainProcessExitEvenHandlerNotLeaking (#10827)</span><span class="sxs-lookup"><span data-stu-id="42f9d-418">Temporary skip the flaky test TestAppDomainProcessExitEvenHandlerNotLeaking (#10827)</span></span>
- <span data-ttu-id="42f9d-419">Gör så att händelse hanteraren läcker testet stabilt (#10790)</span><span class="sxs-lookup"><span data-stu-id="42f9d-419">Make the event handler leaking test stable (#10790)</span></span>
- <span data-ttu-id="42f9d-420">Synkronisera Skift läge i CI YAML (#10767) (tack @RDIL !)</span><span class="sxs-lookup"><span data-stu-id="42f9d-420">Sync capitalization in CI YAML (#10767) (Thanks @RDIL!)</span></span>
- <span data-ttu-id="42f9d-421">Lägg till test för korrigering av händelse hanterare som läcker (#10768)</span><span class="sxs-lookup"><span data-stu-id="42f9d-421">Add test for the event handler leaking fix (#10768)</span></span>
- <span data-ttu-id="42f9d-422">Lägg till get-ChildItem-test (#10507) (tack @iSazonov !)</span><span class="sxs-lookup"><span data-stu-id="42f9d-422">Add Get-ChildItem test (#10507) (Thanks @iSazonov!)</span></span>
- <span data-ttu-id="42f9d-423">Ersätt tvetydigt språk för test från växla till parameter för noggrannhet (#10666) (tack @romero126 !)</span><span class="sxs-lookup"><span data-stu-id="42f9d-423">Replace ambiguous language for tests from switch to parameter for accuracy (#10666) (Thanks @romero126!)</span></span>
- <span data-ttu-id="42f9d-424">Lägg till experimentell kontroll i förgrunden – objekt parallella tester (#10354) (tack @KirkMunro !)</span><span class="sxs-lookup"><span data-stu-id="42f9d-424">Add experimental check to ForEach-Object -Parallel tests (#10354) (Thanks @KirkMunro!)</span></span>
- <span data-ttu-id="42f9d-425">Uppdatera tester för Alpine-validering (#10428)</span><span class="sxs-lookup"><span data-stu-id="42f9d-425">Update tests for Alpine validation (#10428)</span></span>

### <a name="build-and-package-improvements"></a><span data-ttu-id="42f9d-426">Förbättringar av build och paket</span><span class="sxs-lookup"><span data-stu-id="42f9d-426">Build and Package Improvements</span></span>

- <span data-ttu-id="42f9d-427">Åtgärda NuGet-paketets signering för koordinerade paket byggen (#11316)</span><span class="sxs-lookup"><span data-stu-id="42f9d-427">Fix Nuget package signing for Coordinated Package build (#11316)</span></span>
- <span data-ttu-id="42f9d-428">Uppdatera beroenden från PowerShell-galleriet och NuGet (#11323)</span><span class="sxs-lookup"><span data-stu-id="42f9d-428">Update dependencies from PowerShell Gallery and NuGet (#11323)</span></span>
- <span data-ttu-id="42f9d-429">Ojämnhet Microsoft. ApplicationInsights från 2.11.0 till 2.12.0 (#11305)</span><span class="sxs-lookup"><span data-stu-id="42f9d-429">Bump Microsoft.ApplicationInsights from 2.11.0 to 2.12.0 (#11305)</span></span>
- <span data-ttu-id="42f9d-430">Ojämnhet Microsoft. CodeAnalysis. CSharp från 3.3.1 till 3.4.0 (#11265)</span><span class="sxs-lookup"><span data-stu-id="42f9d-430">Bump Microsoft.CodeAnalysis.CSharp from 3.3.1 to 3.4.0 (#11265)</span></span>
- <span data-ttu-id="42f9d-431">Uppdaterings paket för Debian 10 och 11 (#11236)</span><span class="sxs-lookup"><span data-stu-id="42f9d-431">Updates packages for Debian 10 and 11 (#11236)</span></span>
- <span data-ttu-id="42f9d-432">Aktivera endast experimentella funktioner före RC (#11162)</span><span class="sxs-lookup"><span data-stu-id="42f9d-432">Only enable experimental features prior to RC (#11162)</span></span>
- <span data-ttu-id="42f9d-433">Uppdatera lägsta macOS-version (#11163)</span><span class="sxs-lookup"><span data-stu-id="42f9d-433">Update macOS minimum version (#11163)</span></span>
- <span data-ttu-id="42f9d-434">Ojämnhets NJsonSchema från 10.0.27 till 10.0.28 (#11170)</span><span class="sxs-lookup"><span data-stu-id="42f9d-434">Bump NJsonSchema from 10.0.27 to 10.0.28 (#11170)</span></span>
- <span data-ttu-id="42f9d-435">Uppdaterar länkar i README.md och metadata. JSON för för hands versionen. 5 (#10854)</span><span class="sxs-lookup"><span data-stu-id="42f9d-435">Updating links in README.md and metadata.json for Preview.5 (#10854)</span></span>
- <span data-ttu-id="42f9d-436">Välj filer för testning av efterlevnad som ägs av PowerShell (#10837)</span><span class="sxs-lookup"><span data-stu-id="42f9d-436">Select the files for compliance tests which are owned by PowerShell (#10837)</span></span>
- <span data-ttu-id="42f9d-437">Tillåt att win7x86 msix-paketet skapas.</span><span class="sxs-lookup"><span data-stu-id="42f9d-437">Allow win7x86 msix package to build.</span></span> <span data-ttu-id="42f9d-438">(Internt 10515)</span><span class="sxs-lookup"><span data-stu-id="42f9d-438">(Internal 10515)</span></span>
- <span data-ttu-id="42f9d-439">Tillåt att semantiska versioner skickas till NormalizeVersion-funktionen (#11087)</span><span class="sxs-lookup"><span data-stu-id="42f9d-439">Allow semantic versions to be passed to NormalizeVersion function (#11087)</span></span>
- <span data-ttu-id="42f9d-440">Stöter på .NET Core Framework till 3,1 – för hands version. 3 (#11079)</span><span class="sxs-lookup"><span data-stu-id="42f9d-440">Bump .NET core framework to 3.1-preview.3 (#11079)</span></span>
- <span data-ttu-id="42f9d-441">Ojämnhet PSReadLine från 2.0.0-beta5 till 2.0.0-beta6 i/src/Modules (#11078)</span><span class="sxs-lookup"><span data-stu-id="42f9d-441">Bump PSReadLine from 2.0.0-beta5 to 2.0.0-beta6 in /src/Modules (#11078)</span></span>
- <span data-ttu-id="42f9d-442">Ojämnhet Newtonsoft. JSON från 12.0.2 till 12.0.3 (#11037) (#11038)</span><span class="sxs-lookup"><span data-stu-id="42f9d-442">Bump Newtonsoft.Json from 12.0.2 to 12.0.3 (#11037) (#11038)</span></span>
- <span data-ttu-id="42f9d-443">Lägg till Debian 10, 11 och CentOS 8-paket (#11028)</span><span class="sxs-lookup"><span data-stu-id="42f9d-443">Add Debian 10, 11 and CentOS 8 packages (#11028)</span></span>
- <span data-ttu-id="42f9d-444">Ladda upp JSON-filen för build-info med ReleaseDate-fältet (#10986)</span><span class="sxs-lookup"><span data-stu-id="42f9d-444">Upload Build-Info Json file with the ReleaseDate field (#10986)</span></span>
- <span data-ttu-id="42f9d-445">Stöter på .NET Core Framework till 3,1 – för hands version. 2 (#10993)</span><span class="sxs-lookup"><span data-stu-id="42f9d-445">Bump .NET core framework to 3.1-preview.2 (#10993)</span></span>
- <span data-ttu-id="42f9d-446">Aktivera build av x86 MSIX-paket (#10934)</span><span class="sxs-lookup"><span data-stu-id="42f9d-446">Enable build of x86 MSIX package (#10934)</span></span>
- <span data-ttu-id="42f9d-447">Uppdatera URL: en för installations skriptet för dotNET SDK i build. psm1 (#10927)</span><span class="sxs-lookup"><span data-stu-id="42f9d-447">Update the dotnet SDK install script URL in build.psm1 (#10927)</span></span>
- <span data-ttu-id="42f9d-448">Ojämnhet Markdig. signerat från 0.17.1 till 0.18.0 (#10887)</span><span class="sxs-lookup"><span data-stu-id="42f9d-448">Bump Markdig.Signed from 0.17.1 to 0.18.0 (#10887)</span></span>
- <span data-ttu-id="42f9d-449">Ojämnhets ThreadJob från 2.0.1 till 2.0.2 (#10886)</span><span class="sxs-lookup"><span data-stu-id="42f9d-449">Bump ThreadJob from 2.0.1 to 2.0.2 (#10886)</span></span>
- <span data-ttu-id="42f9d-450">Uppdatera AppX-manifest och paketera modul så att de överensstämmer med kraven för MS Store (#10878)</span><span class="sxs-lookup"><span data-stu-id="42f9d-450">Update AppX Manifest and Packaging module to conform to MS Store requirements (#10878)</span></span>
- <span data-ttu-id="42f9d-451">Uppdatera paket referens för PowerShell SDK för för hands version. 5 (internt 10295)</span><span class="sxs-lookup"><span data-stu-id="42f9d-451">Update package reference for PowerShell SDK to preview.5 (Internal 10295)</span></span>
- <span data-ttu-id="42f9d-452">Uppdatera ThirdPartyNotices. txt (#10834)</span><span class="sxs-lookup"><span data-stu-id="42f9d-452">Update ThirdPartyNotices.txt (#10834)</span></span>
- <span data-ttu-id="42f9d-453">Ojämnhet Microsoft. PowerShell. Native to 7.0.0 – för hands version. 3 (#10826)</span><span class="sxs-lookup"><span data-stu-id="42f9d-453">Bump Microsoft.PowerShell.Native to 7.0.0-preview.3 (#10826)</span></span>
- <span data-ttu-id="42f9d-454">Ojämnhet Microsoft. ApplicationInsights från 2.10.0 till 2.11.0 (#10608)</span><span class="sxs-lookup"><span data-stu-id="42f9d-454">Bump Microsoft.ApplicationInsights from 2.10.0 to 2.11.0 (#10608)</span></span>
- <span data-ttu-id="42f9d-455">Ojämnhets NJsonSchema från 10.0.24 till 10.0.27 (#10756)</span><span class="sxs-lookup"><span data-stu-id="42f9d-455">Bump NJsonSchema from 10.0.24 to 10.0.27 (#10756)</span></span>
- <span data-ttu-id="42f9d-456">Lägg till MacPorts-stöd för build-systemet (#10736) (tack @Lucius-Q-User !)</span><span class="sxs-lookup"><span data-stu-id="42f9d-456">Add MacPorts support to the build system (#10736) (Thanks @Lucius-Q-User!)</span></span>
- <span data-ttu-id="42f9d-457">Ojämnhets PackageManagement från 1.4.4 till 1.4.5 (#10728)</span><span class="sxs-lookup"><span data-stu-id="42f9d-457">Bump PackageManagement from 1.4.4 to 1.4.5 (#10728)</span></span>
- <span data-ttu-id="42f9d-458">Ojämnhets NJsonSchema från 10.0.23 till 10.0.24 (#10635)</span><span class="sxs-lookup"><span data-stu-id="42f9d-458">Bump NJsonSchema from 10.0.23 to 10.0.24 (#10635)</span></span>
- <span data-ttu-id="42f9d-459">Lägg till en miljö variabel för att skilja klient/server-telemetri i MSI (#10612)</span><span class="sxs-lookup"><span data-stu-id="42f9d-459">Add environment variable to differentiate client/server telemetry in MSI (#10612)</span></span>
- <span data-ttu-id="42f9d-460">Ojämnhets PSDesiredStateConfiguration från 2.0.3 till 2.0.4 (#10603)</span><span class="sxs-lookup"><span data-stu-id="42f9d-460">Bump PSDesiredStateConfiguration from 2.0.3 to 2.0.4 (#10603)</span></span>
- <span data-ttu-id="42f9d-461">Ojämnhet Microsoft. CodeAnalysis. CSharp från 3.2.1 till 3.3.1 (#10607)</span><span class="sxs-lookup"><span data-stu-id="42f9d-461">Bump Microsoft.CodeAnalysis.CSharp from 3.2.1 to 3.3.1 (#10607)</span></span>
- <span data-ttu-id="42f9d-462">Uppdatera till .net Core 3,0 RTM (#10604) (tack @bergmeister !)</span><span class="sxs-lookup"><span data-stu-id="42f9d-462">Update to .Net Core 3.0 RTM (#10604) (Thanks @bergmeister!)</span></span>
- <span data-ttu-id="42f9d-463">Uppdatera MSIX-paket så att versions kraven för Windows Store (#10588)</span><span class="sxs-lookup"><span data-stu-id="42f9d-463">Update MSIX packaging so the version to Windows Store requirements (#10588)</span></span>
- <span data-ttu-id="42f9d-464">Ojämnhet PowerShellGet-version från 2,2 till 2.2.1 (#10382)</span><span class="sxs-lookup"><span data-stu-id="42f9d-464">Bump PowerShellGet version from 2.2 to 2.2.1 (#10382)</span></span>
- <span data-ttu-id="42f9d-465">Ojämnhet PackageManagement-version från 1.4.3 till 1.4.4 (#10383)</span><span class="sxs-lookup"><span data-stu-id="42f9d-465">Bump PackageManagement version from 1.4.3 to 1.4.4 (#10383)</span></span>
- <span data-ttu-id="42f9d-466">Uppdatera README.md och metadata. JSON för 7.0.0-Preview. 4 (internt 10011)</span><span class="sxs-lookup"><span data-stu-id="42f9d-466">Update README.md and metadata.json for 7.0.0-preview.4 (Internal 10011)</span></span>
- <span data-ttu-id="42f9d-467">Uppgradera .net Core 3,0-versionen från Preview 9 till RC1 (#10552) (tack @bergmeister !)</span><span class="sxs-lookup"><span data-stu-id="42f9d-467">Upgrade .Net Core 3.0 version from Preview 9 to RC1 (#10552) (Thanks @bergmeister!)</span></span>
- <span data-ttu-id="42f9d-468">Åtgärda genereringen av ExperimentalFeature-listor (internt 9996)</span><span class="sxs-lookup"><span data-stu-id="42f9d-468">Fix ExperimentalFeature list generation (Internal 9996)</span></span>
- <span data-ttu-id="42f9d-469">Ojämnhet PSReadLine-version från 2.0.0-beta4 till 2.0.0-beta5 (#10536)</span><span class="sxs-lookup"><span data-stu-id="42f9d-469">Bump PSReadLine version from 2.0.0-beta4 to 2.0.0-beta5 (#10536)</span></span>
- <span data-ttu-id="42f9d-470">Korrigera release build-skript för att ange versions tag gen</span><span class="sxs-lookup"><span data-stu-id="42f9d-470">Fix release build script to set release tag</span></span>
- <span data-ttu-id="42f9d-471">Uppdatera versionen av Microsoft. PowerShell. Native till 7.0.0 – för hands version. 2 (#10519)</span><span class="sxs-lookup"><span data-stu-id="42f9d-471">Update version of Microsoft.PowerShell.Native to 7.0.0-preview.2 (#10519)</span></span>
- <span data-ttu-id="42f9d-472">Uppgradera till Netcoreapp 3.0 preview9 (#10484) (tack @bergmeister !)</span><span class="sxs-lookup"><span data-stu-id="42f9d-472">Upgrade to Netcoreapp3.0 preview9 (#10484) (Thanks @bergmeister!)</span></span>
- <span data-ttu-id="42f9d-473">Se till att den dagliga samordnade versionen vet att det är en daglig version (#10464)</span><span class="sxs-lookup"><span data-stu-id="42f9d-473">Make sure the daily coordinated build, knows it is a daily build (#10464)</span></span>
- <span data-ttu-id="42f9d-474">Uppdatera den kombinerade paket versionen för att frigöra de dagliga build-versionerna (#10449)</span><span class="sxs-lookup"><span data-stu-id="42f9d-474">Update the combined package build to release the daily builds (#10449)</span></span>
- <span data-ttu-id="42f9d-475">Ta bort AppVeyor-referens (#10445) (tack @RDIL !)</span><span class="sxs-lookup"><span data-stu-id="42f9d-475">Remove appveyor reference (#10445) (Thanks @RDIL!)</span></span>
- <span data-ttu-id="42f9d-476">Ojämnhet NJsonSchema-version från 10.0.22 till 10.0.23 (#10421)</span><span class="sxs-lookup"><span data-stu-id="42f9d-476">Bump NJsonSchema version from 10.0.22 to 10.0.23 (#10421)</span></span>
- <span data-ttu-id="42f9d-477">Ta bort borttagningen av linux-x64-installationsmappen eftersom vissa beroenden för Alpine behöver den (#10407)</span><span class="sxs-lookup"><span data-stu-id="42f9d-477">Remove the deletion of linux-x64 build folder because some dependencies for Alpine need it (#10407)</span></span>

### <a name="documentation-and-help-content"></a><span data-ttu-id="42f9d-478">Dokumentation och hjälp innehåll</span><span class="sxs-lookup"><span data-stu-id="42f9d-478">Documentation and Help Content</span></span>

- <span data-ttu-id="42f9d-479">Ändrings loggar i en logg per utgåva (#11165)</span><span class="sxs-lookup"><span data-stu-id="42f9d-479">Refactor change logs into one log per release (#11165)</span></span>
- <span data-ttu-id="42f9d-480">Åtgärda FWLinks för PowerShell 7 direkt hjälp dokument (#11071)</span><span class="sxs-lookup"><span data-stu-id="42f9d-480">Fix FWLinks for PowerShell 7 online help documents (#11071)</span></span>
- <span data-ttu-id="42f9d-481">Uppdatera CONTRIBUTING.md (#11096) (tack @mklement0 !)</span><span class="sxs-lookup"><span data-stu-id="42f9d-481">Update CONTRIBUTING.md (#11096) (Thanks @mklement0!)</span></span>
- <span data-ttu-id="42f9d-482">Åtgärda installations dokument länkar i README.md (#11083)</span><span class="sxs-lookup"><span data-stu-id="42f9d-482">Fix installation doc links in README.md (#11083)</span></span>
- <span data-ttu-id="42f9d-483">Lägger till exempel i skriptet install-PowerShell. ps1 (#11024) (tack @kilasuit !)</span><span class="sxs-lookup"><span data-stu-id="42f9d-483">Adds examples to install-powershell.ps1 script (#11024) (Thanks @kilasuit!)</span></span>
- <span data-ttu-id="42f9d-484">Korrigera för Select-String betoning och import-Dscresource Keyword Supports i CHANGELOG.md (#10890)</span><span class="sxs-lookup"><span data-stu-id="42f9d-484">Fix to Select-String emphasis and Import-DscResource in CHANGELOG.md (#10890)</span></span>
- <span data-ttu-id="42f9d-485">Ta bort den inaktuella länken från powershell-beginners-guide.md (#10926)</span><span class="sxs-lookup"><span data-stu-id="42f9d-485">Remove the stale link from powershell-beginners-guide.md (#10926)</span></span>
- <span data-ttu-id="42f9d-486">Sammanfoga stabila och underhålls ändrings loggar (#10527)</span><span class="sxs-lookup"><span data-stu-id="42f9d-486">Merge stable and servicing change logs (#10527)</span></span>
- <span data-ttu-id="42f9d-487">Uppdatera använda .NET-version i build-dokument (#10775) (tack @Greg-Smulko !)</span><span class="sxs-lookup"><span data-stu-id="42f9d-487">Update used .NET version in build docs (#10775) (Thanks @Greg-Smulko!)</span></span>
- <span data-ttu-id="42f9d-488">Ersätt länkar från MSDN till docs.microsoft.com i powershell-beginners-guide.md (#10778) (tack @iSazonov !)</span><span class="sxs-lookup"><span data-stu-id="42f9d-488">Replace links from MSDN to docs.microsoft.com in powershell-beginners-guide.md (#10778) (Thanks @iSazonov!)</span></span>
- <span data-ttu-id="42f9d-489">Korrigera bruten DSC översikts länk (#10702)</span><span class="sxs-lookup"><span data-stu-id="42f9d-489">Fix broken DSC overview link (#10702)</span></span>
- <span data-ttu-id="42f9d-490">Uppdatera Support_Question. MD för att länka till Stack Overflow som en annan grupp resurs (#10638) (tack @mklement0 !)</span><span class="sxs-lookup"><span data-stu-id="42f9d-490">Update Support_Question.md to link to Stack Overflow as another community resource (#10638) (Thanks @mklement0!)</span></span>
- <span data-ttu-id="42f9d-491">Lägg till processor arkitektur i mallen för distributions förfrågningen (#10661)</span><span class="sxs-lookup"><span data-stu-id="42f9d-491">Add processor architecture to distribution request template (#10661)</span></span>
- <span data-ttu-id="42f9d-492">Lägg till en ny PowerShell-MoL-bok i Learning PowerShell-dokument (#10602)</span><span class="sxs-lookup"><span data-stu-id="42f9d-492">Add new PowerShell MoL book to learning PowerShell docs (#10602)</span></span>
- <span data-ttu-id="42f9d-493">Uppdatera README.md och metadata för v 6.1.6 och v 6.2.3-versioner (#10523)</span><span class="sxs-lookup"><span data-stu-id="42f9d-493">Update README.md and metadata for v6.1.6 and v6.2.3 releases (#10523)</span></span>
- <span data-ttu-id="42f9d-494">Åtgärda ett stavfel i README.md (#10465) (tack @vedhasp !)</span><span class="sxs-lookup"><span data-stu-id="42f9d-494">Fix a typo in README.md (#10465) (Thanks @vedhasp!)</span></span>
- <span data-ttu-id="42f9d-495">Lägg till en referens till PSKoans-modulen i Learning Resources-dokumentationen (#10369) (tack @vexx32 !)</span><span class="sxs-lookup"><span data-stu-id="42f9d-495">Add a reference to PSKoans module to Learning Resources documentation (#10369) (Thanks @vexx32!)</span></span>
- <span data-ttu-id="42f9d-496">Uppdatera README.md och metadata. JSON för 7.0.0-Preview. 3 (#10393)</span><span class="sxs-lookup"><span data-stu-id="42f9d-496">Update README.md and metadata.json for 7.0.0-preview.3 (#10393)</span></span>
