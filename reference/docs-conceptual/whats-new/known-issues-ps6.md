...
PowerShell Core stöder även PowerShell-fjärrkommunikation (PSRP) via SSH på alla plattformar (Windows, macOS och Linux). Även om detta inte stöds i produktion, kan du lära dig mer om att konfigurera detta [här](/powershell/scripting/learn/remoting/SSH-Remoting-in-PowerShell-Core).
...
|Kommandon|Användnings tillstånd|Kommentarer|
|--------|-----------------|-----|
