...
Du kan använda objekten som exponeras av N:Microsoft.PowerShell.ScheduledJob-namnområdet för att skapa ett schemalagt jobb, definiera när det körs och få resultat om det slutförda jobbet när det har körts.

## <a name="triggering-the-job"></a>Utlösa jobbet

Det första steget när du skapar ett schemalagt jobb är att ange när jobbet ska köras. Gör detta genom att skapa och konfigurera ett T:Microsoft.PowerShell.ScheduledJob.ScheduledJobTrigger-objekt. Följande kod skapar en utlösare som schemalägger ett jobb att köras en gång i 20 sekunder i framtiden.
