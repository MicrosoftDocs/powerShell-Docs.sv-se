...
Hantering av OData IIS-tillägg använder XML-filer för att definiera resurs mappning. Följande XSD definierar det schema som används för de här filerna.

## <a name="resource-mapping-file-xsd"></a>Resurs mappnings fil XSD

Följande XSD definierar schemat för OData IIS-tillägg för hantering av OData-filer.
