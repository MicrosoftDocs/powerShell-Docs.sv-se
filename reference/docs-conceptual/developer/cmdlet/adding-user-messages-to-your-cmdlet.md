...
Cmdleten Stop-proc är utformad för att ändra systemet; Därför måste deklarationen [system. Management. Automation. CmdletAttribute](/dotnet/api/System.Management.Automation.CmdletAttribute) för .net-klassen innehålla nyckelordet `SupportsShouldProcess` och anges till `true`.
