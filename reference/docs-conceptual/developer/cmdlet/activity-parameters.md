...
|**log**<br>Datatyp: SwitchParameter|Implementera den här parametern granska åtgärdens åtgärder för cmdleten när parametern anges.|
...
|**Tidsgräns**<br>Datatyp: Int32|Implementera den här parametern så att användaren kan ange timeout-intervall (i millisekunder).|
