...
Det här exemplet visar hur du stöder jobb när du skriver-cmdletar. Om du vill att användarna ska köra cmdleten som ett bakgrunds jobb måste du inkludera koden som beskrivs i följande procedur. Mer information om bakgrunds jobb finns i [bakgrunds jobb](./background-jobs.md).
...
Följande exempel kod visar koden för en **Get-proc-** cmdlet som kan hämta processer internt eller med hjälp av ett bakgrunds jobb.
