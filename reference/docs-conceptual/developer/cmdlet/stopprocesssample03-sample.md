...
1. Med Windows PowerShell 2,0 SDK installerat navigerar du till mappen StopProcessSample03 Standard platsen är C:\Program Files (x86) \Microsoft SDKs\Windows\v7.0\Samples\sysmgmt\WindowsPowerShell\csharp\StopProcessSample03.
...
- Lägger till alias till parameter deklarationer...

- Lägga till stöd för jokertecken i parametrar.

## <a name="example"></a>Exempel

Det här exemplet visar hur du deklarerar parameter Ali Aset och stöder jokertecken.
