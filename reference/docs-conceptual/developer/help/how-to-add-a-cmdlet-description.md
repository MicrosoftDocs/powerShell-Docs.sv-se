...
- Ta med information om hur användarna kan använda cmdleten, förutom den uppenbara användningen. Du kan till exempel använda objektet som cmdleten `Get-Host` hämtar för att ändra färg på text i Windows PowerShell-kommando fönstret.
