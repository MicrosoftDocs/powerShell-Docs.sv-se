...
ms.locfileid: "83557319"
---
# <a name="getproc05-vbnet-sample-code"></a><span data-ttu-id="ddb4d-102">GetProc05 (VB.NET) – kodexempel</span><span class="sxs-lookup"><span data-stu-id="ddb4d-102">GetProc05 (VB.NET) Sample Code</span></span>

<span data-ttu-id="ddb4d-103">Här är den fullständiga VB.NET-koden för exempel-cmdlet: en GetProc05.</span><span class="sxs-lookup"><span data-stu-id="ddb4d-103">Here is the complete VB.NET code for the GetProc05 sample cmdlet.</span></span>
...
## <a name="see-also"></a><span data-ttu-id="ddb4d-104">Se även</span><span class="sxs-lookup"><span data-stu-id="ddb4d-104">See Also</span></span>

[<span data-ttu-id="ddb4d-105">Windows PowerShell SDK</span><span class="sxs-lookup"><span data-stu-id="ddb4d-105">Windows PowerShell SDK</span></span>](../windows-powershell-reference.md)
