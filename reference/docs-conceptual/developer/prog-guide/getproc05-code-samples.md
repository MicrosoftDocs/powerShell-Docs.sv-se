...
Här är kod exemplen för GetProc05-exempel-cmdleten. Denna `Get-Process`-cmdlet liknar den cmdlet som beskrivs i [lägga till ej avslutande fel rapportering till din cmdlet](../cmdlet/adding-non-terminating-error-reporting-to-your-cmdlet.md).
