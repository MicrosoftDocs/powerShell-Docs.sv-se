...
I följande avsnitt beskrivs attributen, underordnade element och det överordnade elementet i `CustomControl`-elementet. Du kan ange valfritt antal underordnade element och lista dem i vilken ordning som helst.
