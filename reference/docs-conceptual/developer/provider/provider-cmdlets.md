...
- `Get-PSProvider`: denna cmdlet returnerar information om de providers som är tillgängliga i sessionen. Du behöver inte skriva över några metoder för att stödja denna cmdlet.