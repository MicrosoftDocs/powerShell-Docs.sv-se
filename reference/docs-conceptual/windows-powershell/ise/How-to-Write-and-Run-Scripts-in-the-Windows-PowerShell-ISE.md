...
1. Tryck på <kbd>CTRL +</kbd>G i rutan skript och + <kbd>G</kbd> Klicka på **gå till rad** på **Redigera** -menyn.
...
1. Klicka på **Spara som** på menyn **Arkiv** . Dialog rutan **Spara som** visas.
