...
Du kan också använda parametrarna för **PowerShell. exe** -programmet för att anpassa sessionen. Mer information finns i [kommando rads hjälpen för PowerShell. exe](/powershell/module/Microsoft.PowerShell.Core/About/about_PowerShell_exe).
