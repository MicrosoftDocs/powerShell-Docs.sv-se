...
`Get-Member -Static`visar konstruktorer, så att du kan visa överlagringar på samma sätt som andra metoder. Prestanda för den här syntaxen är också avsevärt snabbare än `New-Object` .
