...
Den här processen kan köras i samband med en [Schemaläggaren][] jobb eller en [SQL ServerAgent][] jobbet. Där det finns flera PowerShell-processer som körs, kan det vara svårt att veta vilken process representerar problemet. Den här artikeln visar hur du avkoda ett skriptblock som en PowerShell-process körs för tillfället.
