...
Cmdleten och proxy-cmdletarna som genereras av den, stöder nu parametern **headers.** `Export-ODataEndpointProxy` Sidhuvudet kan användas för att kanal ytterligare information som förväntas av OData-slutpunkten.
