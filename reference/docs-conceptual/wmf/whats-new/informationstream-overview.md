...
Variabeln har samlat in process informationen i skript variabeln `$p`. `$r`
...
Till skillnad från `Write-Host` -cmdlet: en med parametern `Write-Information` **InformationVariable** kan du avbilda utdata i en variabel. Med hjälp av **taggen**kan du skapa separata kanaler för meddelanden som skickas till **informations** strömmen.
