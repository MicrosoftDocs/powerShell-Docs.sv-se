...
**Lösning:** Identifiera och Anslut till `Get-PSHostProcessInfo`körnings utrymme med cmdlet: ar, `Enter-PSHostProcess` `Get-Runspace` och `Debug-Runspace` för att felsöka DSC-resursen.
