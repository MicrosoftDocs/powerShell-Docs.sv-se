...
ms.locfileid: "62057388"
---
# <a name="installation-of-module-dependencies"></a><span data-ttu-id="5ae13-102">Installation av modulberoenden</span><span class="sxs-lookup"><span data-stu-id="5ae13-102">Installation of Module Dependencies</span></span>

<span data-ttu-id="5ae13-103">Det finns nu sida-vid-sida (SxS)-modul Versionsstöd i Install-Module, Update-modulen och Publish-Module-cmdletar som körs i Windows PowerShell 5.0 eller senare.</span><span class="sxs-lookup"><span data-stu-id="5ae13-103">There is now side-by-side (SxS) module version support in Install-Module, Update-Module, and Publish-Module cmdlets that run in Windows PowerShell 5.0 or newer.</span></span>
<span data-ttu-id="5ae13-104">Dessutom har vi lagt till en - RequiredVersion-parameter till Publish-Module-cmdlet för att ange vilken version som ska publiceras.</span><span class="sxs-lookup"><span data-stu-id="5ae13-104">Also, we have added a -RequiredVersion parameter to the Publish-Module cmdlet to specify the version to be published.</span></span> <span data-ttu-id="5ae13-105">Parametern Path har nu stöd för modulen rotsökväg med version-mapp.</span><span class="sxs-lookup"><span data-stu-id="5ae13-105">The Path parameter now supports the module base path with the version folder.</span></span>

<span data-ttu-id="5ae13-106">**Install-Module-exempel:**</span><span class="sxs-lookup"><span data-stu-id="5ae13-106">**Install-Module examples:**</span></span>
```powershell
...
<span data-ttu-id="5ae13-107">**Installera en modul med beroenden:**</span><span class="sxs-lookup"><span data-stu-id="5ae13-107">**Install a module with dependencies:**</span></span>
```powershell
PS C:\windows\system32> Get-InstalledModule
...
<span data-ttu-id="5ae13-108">**Innehållet i ModuleWithDependencies2 modulen manifestfil:**</span><span class="sxs-lookup"><span data-stu-id="5ae13-108">**Contents of ModuleWithDependencies2 module manifest file:**</span></span>
```powershell
@{
...
<span data-ttu-id="5ae13-109">**Uppdatera modulen exempel:**</span><span class="sxs-lookup"><span data-stu-id="5ae13-109">**Update-Module examples:**</span></span>
```powershell
...
<span data-ttu-id="5ae13-110">**Publicera-Module-exempel:**</span><span class="sxs-lookup"><span data-stu-id="5ae13-110">**Publish-Module examples:**</span></span>
```powershell
