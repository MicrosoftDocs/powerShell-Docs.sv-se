...
<a name="stop-dscconfiguration-may-hang-in-debugmode"></a>Stop-DscConfiguration låser sig i DebugMode
------------------------------------------------------------------------------------------------------------------------
Om LCM finns i DebugMode, låser Stop-DscConfiguration sig när försök att stoppa en åtgärd startas av Get-DscConfiguration
