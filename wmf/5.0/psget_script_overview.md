...
---
# <a name="powershell-script-discovery-install-and-management-with-powershellget"></a><span data-ttu-id="80f0d-102">PowerShell Script Discovery, installation och hantering av med PowerShellGet</span><span class="sxs-lookup"><span data-stu-id="80f0d-102">PowerShell Script Discovery, Install and Management with PowerShellGet</span></span>

<span data-ttu-id="80f0d-103">Funktionen för delning av PowerShell-skript har lagts till i PowerShellGet i WMF 5.0 RTM-versionen.</span><span class="sxs-lookup"><span data-stu-id="80f0d-103">PowerShell Script sharing feature got added to the PowerShellGet in the WMF 5.0 RTM release.</span></span>
<span data-ttu-id="80f0d-104">Följande nya cmdletar har lagts till PowerShellGet-modulen för att stödja PowerShell-skript.</span><span class="sxs-lookup"><span data-stu-id="80f0d-104">The following new cmdlets are added to the PowerShellGet module for supporting the PowerShell Scripts.</span></span>
```powershell
...
<span data-ttu-id="80f0d-105">Syntaxen för skriptet delning Cmdlets:</span><span class="sxs-lookup"><span data-stu-id="80f0d-105">Syntax of script sharing Cmdlets:</span></span>
```powershell
