...
---
# <a name="powershell-script-discovery-install-and-management-with-powershellget"></a><span data-ttu-id="7ce3a-102">PowerShell-Skriptidentifiering, installation och hantering med PowerShellGet</span><span class="sxs-lookup"><span data-stu-id="7ce3a-102">PowerShell Script Discovery, Install and Management with PowerShellGet</span></span>

<span data-ttu-id="7ce3a-103">Funktionen för delning av PowerShell-skript har lagts till i PowerShellGet i WMF 5.0 RTM-versionen.</span><span class="sxs-lookup"><span data-stu-id="7ce3a-103">PowerShell Script sharing feature got added to the PowerShellGet in the WMF 5.0 RTM release.</span></span>
<span data-ttu-id="7ce3a-104">Följande nya cmdletar har lagts till modulen PowerShellGet för att stödja PowerShell-skript.</span><span class="sxs-lookup"><span data-stu-id="7ce3a-104">The following new cmdlets are added to the PowerShellGet module for supporting the PowerShell Scripts.</span></span>
```powershell
...
<span data-ttu-id="7ce3a-105">Syntaxen för skriptet delning cmdletar:</span><span class="sxs-lookup"><span data-stu-id="7ce3a-105">Syntax of script sharing Cmdlets:</span></span>
```powershell
