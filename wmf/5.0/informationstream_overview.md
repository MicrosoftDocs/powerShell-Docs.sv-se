...
En ny strukturerade informationsström kan nu användas för att överföra strukturerade data mellan ett skript och dess värd. **Skriv-Host** har också uppdaterats för att generera dess utdata till informationsström där du kan nu avbilda eller inaktivera den. Den nya **skriva Information** cmdlet (tillsammans med en motsvarande WriteInformation-API) som används med **- InformationVariable** och **- InformationAction** gemensamma parametrar möjliggör mer flexibilitet och funktion.
