...
---
# <a name="information-stream"></a>Information dataström

En ny strukturerade Information dataström kan nu användas för att överföra strukturerade data mellan ett skript och värden. **Skriv värden** har också uppdaterats för att generera utdata till dataströmmen Information där du kan nu avbilda eller inaktivera den. Den nya **skriva Information** cmdlet (tillsammans med en motsvarande WriteInformation-API) som används med **- InformationVariable** och **- InformationAction** gemensamma parametrar möjliggör större flexibilitet och kapaciteten.
