...
---
# <a name="information-stream"></a><span data-ttu-id="76268-102">Information dataström</span><span class="sxs-lookup"><span data-stu-id="76268-102">Information Stream</span></span>

<span data-ttu-id="76268-103">En ny strukturerade Information dataström kan nu användas för att överföra strukturerade data mellan ett skript och värden.</span><span class="sxs-lookup"><span data-stu-id="76268-103">A new structured Information stream can now be used to transmit structured data between a script and its host.</span></span> <span data-ttu-id="76268-104">**Skriv värden** har också uppdaterats för att generera utdata till dataströmmen Information där du kan nu avbilda eller inaktivera den.</span><span class="sxs-lookup"><span data-stu-id="76268-104">**Write-Host** has also been updated to emit its output to the Information stream where you can now capture or silence it.</span></span> <span data-ttu-id="76268-105">Den nya **skriva Information** cmdlet (tillsammans med en motsvarande WriteInformation-API) som används med **- InformationVariable** och **- InformationAction** gemensamma parametrar möjliggör större flexibilitet och kapaciteten.</span><span class="sxs-lookup"><span data-stu-id="76268-105">The new **Write-Information** cmdlet (along with a corresponding WriteInformation API) used with **-InformationVariable** and **-InformationAction** common parameters enables more flexibility and capability.</span></span>
