...
På Windows 7, kan med hjälp av PowerShell-moduler och DSC-resurser resultera i fel som rapporterats om ExecutionPolicy.

**Lösning:** Ange ExecutionPolicy **RemoteSigned** genom att köra följande kommando i en upphöjd PowerShell-session (Kör som administratör):
...
**Lösning:** Kör den `Start-SilLogging` cmdlet en gång efter WMF-installationen som installationsprocessen avbryts felaktigt funktionen Software Inventory Logging.
